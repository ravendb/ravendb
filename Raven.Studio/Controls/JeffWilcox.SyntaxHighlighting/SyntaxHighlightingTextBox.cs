...
namespace Raven.Studio.Controls.JeffWilcox.SyntaxHighlighting
{
	...
	public class SyntaxHighlightingTextBox : Control
	{
		...
		const string TextBlockSelectionName = "TextBlockSelection";

		/// <summary>
		/// Identifies the <see cref="IsReadOnly"/> dependency property.
		/// </summary>
		public static readonly DependencyProperty IsReadOnlyProperty =
			DependencyProperty.Register("IsReadOnly", typeof (bool), typeof (SyntaxHighlightingTextBox),
		...
		{
			var source = d as SyntaxHighlightingTextBox;
		...
		void _textBlockSelection_TextChanged(object sender, TextChangedEventArgs e)
		{
			SourceCode = (sender as TextBox).Text;
		}
