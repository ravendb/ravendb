...
namespace Raven.Studio.Controls.JeffWilcox.SyntaxHighlighting
{
	...
	class LanguageParser : ILanguageParser
	{
		...
		static List<Scope> CreateCapturedStyleTree(IList<Scope> capturedStyles)
		{
		...
		void AppendCapturedStylesForRegexCapture(Capture regexCapture,
		                                         int currentIndex,
		                                         string styleName,
		...
		static void IncreaseCapturedStyleIndicies(IList<Scope> capturedStyles,
