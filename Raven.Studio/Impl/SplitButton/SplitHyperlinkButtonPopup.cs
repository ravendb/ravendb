...
namespace Delay
{
    ...
    public class SplitHyperlinkButtonPopup : HyperlinkButton
    {
        public static readonly DependencyProperty PopupContentProperty =
            DependencyProperty.Register("PopupContent", typeof (object), typeof (SplitHyperlinkButtonPopup), new PropertyMetadata(default(object)));

        public static readonly DependencyProperty PopupAlignmentProperty =
            DependencyProperty.Register("PopupAlignment", typeof (PopupHorizontalAlignment), typeof (SplitHyperlinkButtonPopup), new PropertyMetadata(PopupHorizontalAlignment.Left));
        ...
        /// </summary>
        public SplitHyperlinkButtonPopup()
        {
            DefaultStyleKey = typeof(SplitHyperlinkButtonPopup);
        }
