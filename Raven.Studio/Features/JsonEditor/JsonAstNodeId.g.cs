namespace Raven.Studio.Features.JsonEditor
{
    ...
    public partial class JsonAstNodeId : AstNodeIdProviderBase
    {
        ...
        /// </summary>
        [DescriptionAttribute("Json array")] public const Int32 JsonArrayNode = 1;

        /// <summary>
        /// Gets the <c>JsonObjectNode</c> AST node ID.
        /// </summary>
        [DescriptionAttribute("Json object")] public const Int32 JsonObjectNode = 2;

        /// <summary>
        /// Gets the <c>JsonPropertyValuePairNode</c> AST node ID.
        /// </summary>
        [DescriptionAttribute("Json property value pair")] public const Int32 JsonPropertyValuePairNode = 3;

        /// <summary>
        /// Gets the <c>JsonStringNode</c> AST node ID.
        /// </summary>
        [DescriptionAttribute("Json string")] public const Int32 JsonStringNode = 4;
