...
namespace Raven.Performance
{
	public class Program
	{
		...
		private static void QueryByFullName(IDocumentStore store)
		{
		...
		private static void QueryByPartialName(IDocumentStore store)
		{
			var sp = Stopwatch.StartNew();
		...
		private static void WaitForNonStaleResult(IDocumentStore store)
		{
			var sp = Stopwatch.StartNew();
		...
		private static void WriteData(IDocumentStore store)
		{
			...
			Console.WriteLine("Wrote {0:#,#} documents in {1:#,#}ms: {2:#,#.##}: docs/ms", names.Length, sp.ElapsedMilliseconds, 
