...
Follow the web setup instructions at: https://ravendb.net/docs/article-page/7.0/csharp/start/installation/setup-wizard

* Upgrading to a New Version
Follow the upgrade instructions available at: https://ravendb.net/docs/article-page/7.0/csharp/start/installation/upgrading-to-new-version
