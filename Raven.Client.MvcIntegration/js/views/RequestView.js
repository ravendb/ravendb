/*global window*/
define(['backbone', 'underscore', './templateHelper', 'text!./templates/request.html', './RequestDetailsView'], function (Backbone, _, templateHelper, requestTemplate, RequestDetailsView) {
