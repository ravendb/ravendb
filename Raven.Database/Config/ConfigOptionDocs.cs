...
namespace Raven.Database.Config
{
	internal class ConfigOptionDocs : IEnumerable<string>
	{
		public readonly static ConfigOptionDocs OptionsDocs = new ConfigOptionDocs
		{
			...
			{"Raven/Esent/MaxVerPages", "int", null, "The maximum size of version store (in memory modified data) available. The value is in megabytes. Default: 160."},
			{"Raven/Esent/PreferredVerPages", "int", null, "The preferred size of version store (in memory modified data) available. If the value exceed that level, optional background tasks data are removed from the version strong. The value is in megabytes. Default: 128."},
