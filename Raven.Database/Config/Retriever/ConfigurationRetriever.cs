        ...
        private readonly Dictionary<string, DocumentType> documentTypes = new Dictionary<string, DocumentType>(StringComparer.OrdinalIgnoreCase)
                                                                          {
                                                                              ...
                                                                              {RavenConfiguration.GetKey(x => x.Quotas.DocsHardLimit), DocumentType.QuotasConfiguration},
                                                                              {RavenConfiguration.GetKey(x => x.Quotas.DocsSoftLimit), DocumentType.QuotasConfiguration},
                                                                              {RavenConfiguration.GetKey(x => x.Quotas.SizeHardLimit), DocumentType.QuotasConfiguration},
                                                                              {RavenConfiguration.GetKey(x => x.Quotas.SizeSoftLimit), DocumentType.QuotasConfiguration},
