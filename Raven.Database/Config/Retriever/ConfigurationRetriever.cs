        ...
        private readonly Dictionary<string, DocumentType> documentTypes = new Dictionary<string, DocumentType>(StringComparer.OrdinalIgnoreCase)
                                                                          {
                                                                              ...
                                                                              {InMemoryRavenConfiguration.GetKey(x => x.Quotas.DocsHardLimit), DocumentType.QuotasConfiguration},
                                                                              {InMemoryRavenConfiguration.GetKey(x => x.Quotas.DocsSoftLimit), DocumentType.QuotasConfiguration},
                                                                              {InMemoryRavenConfiguration.GetKey(x => x.Quotas.SizeHardLimit), DocumentType.QuotasConfiguration},
                                                                              {InMemoryRavenConfiguration.GetKey(x => x.Quotas.SizeSoftLimit), DocumentType.QuotasConfiguration},
