		...
		internal class IndexQueryOperation
		{
			...
			public Query GetLuceneQuery()
			{
				...
				if (spatialIndexQuery != null)
				{
					...
					var dq = spatialField.MakeQuery(q, spatialField.GetLuceneStrategy(), spatialIndexQuery.QueryShape, spatialIndexQuery.SpatialRelation, spatialIndexQuery.DistanceErrorPercentage);
