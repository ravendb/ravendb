...
namespace Raven.Bundles.Quotas.Size
{
	public class SizeQuotaConfiguration
	{
		...
		public SizeQuotaConfiguration(DocumentDatabase database)
		{
			...
			var hardLimitQuotaAsString = database.ConfigurationRetriever.GetConfigurationSetting(Constants.SizeHardLimitInKB);
			var marginAsString = database.ConfigurationRetriever.GetConfigurationSetting(Constants.SizeSoftLimitInKB);
