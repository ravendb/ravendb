...
// https://rx.codeplex.com/license Apache License 2.0 (Apache)
...
namespace Raven.Database.Util
{
	...
	public sealed class CompositeDisposable : ICollection<IDisposable>
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Raven.Database.Util.CompositeDisposable"/> class with no disposables contained by it initially.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Raven.Database.Util.CompositeDisposable"/> class with the specified number of disposables.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Raven.Database.Util.CompositeDisposable"/> class from a group of disposables.
		/// </summary>
