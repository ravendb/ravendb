...
namespace Raven.Database.Storage.Voron.Impl
{
	...
	public class TableStorage : IDisposable
	{
		...
		private void CreateReduceResultsSchema(Transaction tx)
		{
			...
			env.CreateTree(tx, ReduceResults.GetIndexKey(Tables.ReduceResults.Indices.ByViewAndHashedReduceKeyAndLevel));
			env.CreateTree(tx, ReduceResults.GetIndexKey(Tables.ReduceResults.Indices.ByViewAndHashedReduceKeyAndLevelAndSourceBucket));
			env.CreateTree(tx, ReduceResults.GetIndexKey(Tables.ReduceResults.Indices.ByViewAndHashedReduceKeyAndLevelAndBucket));
		...
		private void CreateMappedResultsSchema(Transaction tx)
		{
			...
			env.CreateTree(tx, MappedResults.GetIndexKey(Tables.MappedResults.Indices.ByViewAndHashedReduceKey));
			env.CreateTree(tx, MappedResults.GetIndexKey(Tables.MappedResults.Indices.ByViewAndHashedReduceKeyAndSourceBucket));
		...
		private void CreateScheduledReductionsSchema(Transaction tx)
		{
			...
			env.CreateTree(tx, ScheduledReductions.GetIndexKey(Tables.ScheduledReductions.Indices.ByViewAndLevelAndHashedReduceKey));
		}
		...
		private void Initialize()
		{
            ...
            ScheduledReductions = new Table(Tables.ScheduledReductions.TableName, bufferPool, Tables.ScheduledReductions.Indices.ByView, Tables.ScheduledReductions.Indices.ByViewAndLevelAndHashedReduceKey, Tables.ScheduledReductions.Indices.ByViewAndLevel);
			MappedResults = new Table(Tables.MappedResults.TableName, bufferPool, Tables.MappedResults.Indices.ByView, Tables.MappedResults.Indices.ByViewAndDocumentId, Tables.MappedResults.Indices.ByViewAndHashedReduceKey, Tables.MappedResults.Indices.ByViewAndHashedReduceKeyAndSourceBucket, Tables.MappedResults.Indices.Data);
			...
			ReduceResults = new Table(Tables.ReduceResults.TableName, bufferPool, Tables.ReduceResults.Indices.ByView, Tables.ReduceResults.Indices.ByViewAndHashedReduceKeyAndLevel, Tables.ReduceResults.Indices.ByViewAndHashedReduceKeyAndLevelAndSourceBucket, Tables.ReduceResults.Indices.ByViewAndHashedReduceKeyAndLevelAndBucket, Tables.ReduceResults.Indices.Data);
