...
namespace Raven.Database.Storage
{
    public interface IMappedResultsStorageAction
    {
        ...
        IEnumerable<ReduceTypePerKey> GetReduceTypesPerKeys(int index, int take, int limitOfItemsToReduceInSingleStep, Action<string> onError, CancellationToken cancellationToken);
