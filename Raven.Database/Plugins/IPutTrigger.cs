...
namespace Raven.Database.Plugins
{
	...
	public interface IPutTrigger 
	{
	    ...
	    VetoResult AllowPut(string key, JObject document, JObject metadata, TransactionInformation transactionInformation);
	    ...
	    /// <param name="metadata">The new document metadata</param>
	    /// <param name="transactionInformation">The current transaction, if it exists</param>
	    void OnPut(string key, JObject document, JObject metadata, TransactionInformation transactionInformation);
