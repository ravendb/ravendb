...
"
    	...
    	/// </remarks>
    	TSelf WhereEquals
    	(string fieldName, object value, bool isAnalyzed);
    	...
    	TSelf WhereBetween
    	(string fieldName, object start, object end);
    	...
    	/// <returns></returns>
    	TSelf WaitForNonStaleResultsAsOf
    	(DateTime
    	cutOff)
    	;
    	...
    	/// <param name="waitTimeout">The wait timeout.</param>
    	TSelf WaitForNonStaleResultsAsOf
    	(DateTime cutOff, TimeSpan waitTimeout);
    	...
    	TSelf AddOrder
    	(string fieldName, bool descending);
    	...
    	TSelf AddOrder
    	(string fieldName, bool descending, Type fieldType);
    	...
    	/// </remarks>
    	TSelf GroupBy
    	(AggregationOperation aggregationOperation, params string[] fieldsToGroupBy);
    }
    }