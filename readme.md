...
## Getting Started
Install and [set up your database](https://ravendb.net/docs/article-page/7.1/csharp/start/getting-started).
...
We keep adding new features to improve your RavenDB experience. Check out [our latest improvements](https://ravendb.net/docs/article-page/7.1/csharp/start/whats-new), updated weekly.

## Documentation
Access [full documentation](https://ravendb.net/docs/article-page/7.1/csharp) for RavenDB. Like our database, it is easy to use.
...
First please [review and set up prerequisites](https://ravendb.net/docs/article-page/7.1/csharp/start/getting-started#prerequisites).
...
```powershell
   dotnet add package RavenDB.Client --version 7.1.0-*
```
