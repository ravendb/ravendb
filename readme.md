...
#### .deb package 🐧
- Install with `apt`! Manual is here - [.deb installation guide](https://ravendb.net/docs/article-page/8.0/csharp/start/installation/gnu-linux/deb)
...
- [Latest improvements](https://ravendb.net/docs/article-page/8.0/csharp/start/whats-new), updated weekly.
