...
#### .deb package 🐧
- Install with `apt`! Manual is here - [.deb installation guide](https://ravendb.net/docs/article-page/7.2/csharp/start/installation/gnu-linux/deb)
...
- [Latest improvements](https://ravendb.net/docs/article-page/7.2/csharp/start/whats-new), updated weekly.
