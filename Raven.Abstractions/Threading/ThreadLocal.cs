...
namespace Raven.Abstractions.Threading
{
	/// <summary>
	...
	public class ThreadLocal<T> : IDisposable
	{
		...
		private T GetValueSlow()
		{
			...
			if (id < 0)
			{
				...
				throw new ObjectDisposedException("ThreadLocal_Disposed"); // GetResourceString not supported in mono currently..
			}
		...
		private static int GetNewTableSize(int minSize)
		{
			...
			if ((uint)minSize > 16 * 1024) // MaxArrayLength not supported in mono currently..
			{
