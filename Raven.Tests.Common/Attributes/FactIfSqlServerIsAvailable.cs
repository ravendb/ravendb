    ...
    public class MaybeSqlServerIsAvailable
    {
        ...
        private static ConnectionStringSettings GetAppropriateConnectionStringNameInternal()
        {
            ...
            })
            {
                ...
                {
                    conn = ConnectionStringSettings(connectionString.Name, connectionString.ConnectionString.Replace("Initial Catalog=Raven.Tests", "Initial Catalog=Raven.Tests" + Environment.MachineName), connectionString.ProviderName);
                }
