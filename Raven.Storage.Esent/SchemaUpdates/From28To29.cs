//-----------------------------------------------------------------------
// <copyright file="From28To29.cs" company="Hibernating Rhinos LTD">
...
{
	public class From28To29 : ISchemaUpdate
	{
		...
		public void Update(Session session, JET_DBID dbid)
		{
			...
			using (tx = new Transaction(session))
			{
				...
				using (var details = new Table(session, dbid, "details", OpenTableGrbit.None))
				{
					...
					{
						Api.SetColumn(session, details, columnids["schema_version"], "2.9", Encoding.Unicode);
