...
namespace Raven.Tests.Issues
{
    ...
    public class ReplicationBehavior : ReplicationBase
    {
        ...
        public void ReadStriping()
        {
            ...
            {
                var req = i + 1;
                replicationInformer.ExecuteWithReplicationAsync<int>(HttpMethod.Get, "http://localhost:1", new OperationCredentials(null, CredentialCache.DefaultNetworkCredentials), null, req, req, url =>
                {
