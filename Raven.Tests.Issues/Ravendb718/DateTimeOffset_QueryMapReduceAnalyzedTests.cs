...
namespace Raven.Tests.Issues.Ravendb718
{
	public class DateTimeOffset_QueryMapReduceAnalyzedTests : RavenTest
	{
		...
		[Fact]
		public void DateTimeOffset_FromUtcNow_OnMapReduceAnalyzedIndex_Queries_WithCorrectOffset()
		{
			DoTest(DateTimeOffset.UtcNow);
		}

		[Fact]
		public void DateTimeOffset_FromNew_OnMapReduceAnalyzedIndex_Queries_WithCorrectOffset()
		{
