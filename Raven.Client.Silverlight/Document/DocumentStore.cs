...
namespace Raven.Client.Document
{
	...
	public class DocumentStore : IDocumentStore
	{
		...
		public IDictionary<string, string> SharedOperationsHeaders { get; private set; }
		...
		public IDatabaseCommands DatabaseCommands
		{
			get
			{
				...
				foreach (var kvp in SharedOperationsHeaders)
				{
					commands.OperationsHeaders[kvp.Key] = kvp.Value;
				}
				return commands;
			}
		}
		...
		public DocumentStore()
		{
			...
			SharedOperationsHeaders = new Dictionary<string, string>();
