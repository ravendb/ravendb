...
namespace Nevar.Impl
{
    public class Transaction : IDisposable
    {
        ...
        private bool _freeSpaceGathered;
        ...
        public void SetAvailableFreeSpace(List<long> availableFreeSpace, Slice freeSpaceKey)
	    {
	        _freeSpace = availableFreeSpace;
            _freeSpaceKey = freeSpaceKey;
            _originalFreeSpaceCount = availableFreeSpace.Count;
	    }
        ...
        /// </summary>
        private unsafe void GatherFreeSpace()
        {
            ...
            if (_freeSpaceGathered)
                return;

            _freeSpaceGathered = true;
                ...
                do
                {
                    ...
                    using (var reader = new BinaryReader(data))
                    {
                        for (int i = 0; i < remainingPages; i++)
                        {
                            ...
                            Debug.Assert(pageNum >= 2 && pageNum <= _pager.NumberOfAllocatedPages);
#if DEBUG
        ...
        private void SaveOldFreeSpace()
        {
            ...
            if (_freeSpace.Count == 0)
            {
                ...
                _env.SetFreeSpace(_freeSpace, null);
                return;
            }
            ...
            _env.SetFreeSpace(_freeSpace, _freeSpaceKey);
        }
