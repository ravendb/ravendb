...
namespace Corax.Analyzers
{
    public unsafe class Analyzer : IDisposable
    {
        ...
        protected Analyzer(
            delegate*<Analyzer, ReadOnlySpan<byte>, ref Span<byte>, ref Span<Token>, ref byte[], void> functionUtf8, in ITokenizer tokenizer, ITransformer[] transformers) : this(null, functionUtf8, tokenizer, transformers)
        {
        }

        protected Analyzer(Analyzer inner,
            delegate*<Analyzer, ReadOnlySpan<byte>, ref Span<byte>, ref Span<Token>, ref byte[], void> functionUtf8, in ITokenizer tokenizer, ITransformer[] transformers)
        {
            _inner = inner;
            ...
            where TTransform3 : ITransformer
        {
            ...
            return new Analyzer(funcUtf8, tokenizer, new ITransformer[] { transform1, transform2, transform3 });
        }
            ...
            where TTransform1 : ITransformer
        {
            ...
            return new Analyzer(this, funcUtf8, default(NullTokenizer), new ITransformer[] { transform1 });
        }
            ...
            where TTransform2 : ITransformer
        {
            ...
            return new Analyzer(this, funcUtf8, default(NullTokenizer), new ITransformer[] { transform1, transform2 });
        }
            ...
            where TTransform3 : ITransformer
        {
            ...
            return new Analyzer(this, funcUtf8, default(NullTokenizer), new ITransformer[] { transform1, transform2, transform3 });
        }
