...
namespace Corax.Querying.Matches
{
    unsafe partial struct UnaryMatch<TInner, TValueType>
    {
        ...
        public static UnaryMatch<TInner, TValueType> YieldIsNull(in TInner inner, Querying.IndexSearcher searcher, FieldMetadata field,
        ...
        public static UnaryMatch<TInner, TValueType> YieldIsNotNull(in TInner inner, Querying.IndexSearcher searcher, FieldMetadata field,
            UnaryMatchOperationMode mode = UnaryMatchOperationMode.Any, int take = -1)
        {
            return new UnaryMatch<TInner, TValueType>(
        ...
        public static UnaryMatch<TInner, TValueType> YieldGreaterThan(in TInner inner, Querying.IndexSearcher searcher, FieldMetadata field, TValueType value,
        ...
        public static UnaryMatch<TInner, TValueType> YieldGreaterThanOrEqualMatch(in TInner inner, Querying.IndexSearcher searcher, FieldMetadata field, TValueType value,
            UnaryMatchOperationMode mode = UnaryMatchOperationMode.Any, int take = -1)
        {
            if (typeof(TValueType) == typeof(Slice))
            {
        ...
        public static UnaryMatch<TInner, TValueType> YieldLessThan(in TInner inner, Querying.IndexSearcher searcher, FieldMetadata field, TValueType value,
            UnaryMatchOperationMode mode = UnaryMatchOperationMode.Any,
            int take = -1)
        {
            if (typeof(TValueType) == typeof(Slice))
        ...
        public static UnaryMatch<TInner, TValueType> YieldLessThanOrEqualMatch(in TInner inner, Querying.IndexSearcher searcher, FieldMetadata field, TValueType value,
            UnaryMatchOperationMode mode = UnaryMatchOperationMode.Any, int take = -1)
        {
            if (typeof(TValueType) == typeof(Slice))
            {
        ...
        public static UnaryMatch<TInner, TValueType> YieldNotEqualsMatch(in TInner inner, Querying.IndexSearcher searcher, FieldMetadata field, TValueType value,
            UnaryMatchOperationMode mode = UnaryMatchOperationMode.Any, int take = -1)
        {
            if (typeof(TValueType) == typeof(Slice))
            {
        ...
        public static UnaryMatch<TInner, TValueType> YieldEqualsMatch(in TInner inner, Querying.IndexSearcher searcher, FieldMetadata binding, TValueType value,
            UnaryMatchOperationMode mode = UnaryMatchOperationMode.Any, int take = -1)
        {
            if (typeof(TValueType) == typeof(Slice))
            {
        ...
        public static UnaryMatch<TInner, TValueType> YieldAllIn(in TInner inner, Querying.IndexSearcher searcher, FieldMetadata field, TValueType value,
            UnaryMatchOperationMode mode = UnaryMatchOperationMode.Any, int take = -1)
        {
            return new UnaryMatch<TInner, TValueType>(
