...
unsafe partial struct SortingMatch<TInner>
{
    ...
    private struct EntryComparerByScore : IEntryComparer, IComparer<UnmanagedSpan>
    {
            ...
            bool descending = false)
        {
            ...
            var heapSorter = HeapSorterBuilder.BuildSingleNumericalSorter(indexes.Slice(0, heapSize), terms, descending == false, match._nullIsSmallest);
    ...
    private struct EntryComparerByTerm : IEntryComparer, IComparer<UnmanagedSpan>
    {
            ...
            where TComparer : struct, IComparer<long>
        {
            ...
            var nullValue = match._nullIsSmallest
                ? 0
                : -1 >>> 16;
    ...
    private struct EntryComparerByLong : IEntryComparer, IComparer<UnmanagedSpan>
    {
            ...
            bool descending = false)
        {
            ...
            var missingValue = match._nullIsSmallest ? long.MinValue : long.MaxValue;
            ...
            var sorter = HeapSorterBuilder.BuildSingleNumericalSorter(indexes.Slice(0, heapSize), terms, descending, match._nullIsSmallest);
    ...
    private struct EntryComparerByDouble : IEntryComparer, IComparer<UnmanagedSpan>
    {
            ...
            bool descending = false)
        {
            ...
            var missingValue = match._nullIsSmallest ? double.MinValue : double.MaxValue;
    ...
    private struct EntryComparerByTermAlphaNumeric : IEntryComparer, IComparer<UnmanagedSpan>
    {
            ...
            bool descending = false)
        {
            ...
            var heap = HeapSorterBuilder.BuildSingleAlphanumericalSorter(documents, terms, _allocator, descending, match._nullIsSmallest);
    ...
    private struct EntryComparerBySpatial : IEntryComparer, IComparer<UnmanagedSpan>
    {
            ...
            bool descending = false)
        {
            ...
            var heapSorter = HeapSorterBuilder.BuildSingleNumericalSorter<SpatialResult>(indexes.Slice(0, heapSize), terms, descending, match._nullIsSmallest);
            ...
            for (int i = 0; i < batchResults.Length; i++)
            {
                ...
                {
                    distance = new SpatialResult() { Distance = match._nullIsSmallest ? double.MinValue : double.MaxValue, Latitude = Double.NaN, Longitude = Double.NaN };
                }
                else
                {
