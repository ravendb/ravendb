...
namespace Corax.Querying.Matches
{
    unsafe partial struct UnaryMatch<TInner, TValueType>
    {
        ...
        public static UnaryMatch<TInner, TValueType> YieldBetweenMatch<TLeftSideComparer, TRightSideComparer>(in TInner inner, Querying.IndexSearcher searcher, FieldMetadata field, TValueType value1, TValueType value2, int take = -1)
            where TLeftSideComparer : IUnaryMatchComparer
            where TRightSideComparer : IUnaryMatchComparer
        {
        ...
        public static UnaryMatch<TInner, TValueType> YieldNotBetweenMatch<TLeftSideComparer, TRightSideComparer>(in TInner inner, Querying.IndexSearcher searcher, FieldMetadata field, TValueType value1, TValueType value2, int take = -1)
            where TLeftSideComparer : IUnaryMatchComparer
            where TRightSideComparer : IUnaryMatchComparer
        {
            if (typeof(TValueType) == typeof(Slice))
