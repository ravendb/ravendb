...
public partial class IndexSearcher
{
    ...
    // private MultiTermMatch SingleRangeBuilder<TScoreFunction, TValue>(Slice fieldName, TValue value, UnaryMatchOperation operation, TScoreFunction scoreFunction, bool isNegated)
    //     where TScoreFunction : IQueryScoreFunction
    // {
    //     switch (operation)
    //     {
    ...
    //             return value switch
    //             {
    //                 long l => RangeBuilder<TScoreFunction, Range.Inclusive, Range.Exclusive>(fieldName, value, long.MaxValue, )
    //             }
    //     }
    //     
    //     
