...
namespace Raven.Server.Config.Categories
{
    public class DatabaseConfiguration : ConfigurationCategory
    {
        ...
        [ConfigurationEntry("Databases.ConcurrentResourceLoadTimeoutInSec")]
        ...
        /// </summary>
        [DefaultValue(8)]
        [ConfigurationEntry("Databases.MaxConcurrentResourceLoads")]
        public int MaxConcurrentResourceLoads { get; set; }

        [DefaultValue(900)]
        [TimeUnit(TimeUnit.Seconds)]
        [ConfigurationEntry("Databases.MaxIdleTimeForTenantDatabaseInSec")]
        ...
        [DefaultValue(60)]
        [TimeUnit(TimeUnit.Seconds)]
        [ConfigurationEntry("Databases.FrequencyToCheckForIdleDatabasesInSec")]
