...
namespace Raven.Server.Config.Categories
{
    public class ClusterConfiguration : ConfigurationCategory
    {
        ...
        [ConfigurationEntry("Cluster.ElectionTimeoutInMs", isServerWideOnly: true)]
        ...
        [DefaultValue(250)]
        [TimeUnit(TimeUnit.Milliseconds)]
        [ConfigurationEntry("Cluster.WorkerSamplePeriodInMs", isServerWideOnly: true)]
        ...
        [DefaultValue(500)]
        [TimeUnit(TimeUnit.Milliseconds)]
        [ConfigurationEntry("Cluster.SupervisorSamplePeriodInMs", isServerWideOnly: true)]
        ...
        [DefaultValue(1000)]
        [TimeUnit(TimeUnit.Milliseconds)]
        [ConfigurationEntry("Cluster.ReceiveFromWorkerTimeoutInMs", isServerWideOnly: true)]
        ...
        [DefaultValue(5000)]
        [TimeUnit(TimeUnit.Milliseconds)]
        [ConfigurationEntry("Cluster.OnErrorDelayTimeInMs", isServerWideOnly: true)]
        ...
        [ConfigurationEntry("Cluster.OperationTimeoutInSec", isServerWideOnly: true)]
        ...
        [DefaultValue(5)]
        [TimeUnit(TimeUnit.Seconds)]
        [ConfigurationEntry("Cluster.StatsStabilizationTimeInSec", isServerWideOnly: true)]
        ...
        [DefaultValue(15 * 60)]
        [TimeUnit(TimeUnit.Seconds)]
        [ConfigurationEntry("Cluster.TimeBeforeAddingReplicaInSec", isServerWideOnly: true)]
        public TimeSetting AddReplicaTimeout{ get; set; }

        [Description("Tcp connection read/write timeout.")]
        [DefaultValue(15 * 1000)]
        [TimeUnit(TimeUnit.Milliseconds)]
        [ConfigurationEntry("Cluster.TcpTimeout", isServerWideOnly: true)]
        ...
        [DefaultValue(true)]
        [ConfigurationEntry("Cluster.HardDeleteOnReplacement", isServerWideOnly: true)]
