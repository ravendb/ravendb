...
namespace Raven.Server.Config.Categories
{
    public class SecurityConfiguration : ConfigurationCategory
    {
        ...
        [DefaultValue(false)]
        [ConfigurationEntry("Security.DisableHttpsRedirection", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.AuditLog.FolderPath", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        public PathSetting AuditLogPath { get; set; }

        [Description("How far back we should retain audit log entries")]
        [DefaultValue(365 * 24)]
        [TimeUnit(TimeUnit.Hours)]
        [ConfigurationEntry("Security.AuditLog.RetentionTimeInHrs", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        [ConfigurationEntry("Security.AuditLog.RetentionTimeInHours", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [ConfigurationEntry("Security.AuditLog.RetentionSizeInMb", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        public Size? AuditLogRetentionSize { get; set; }

        [Description("Will determine whether to compress the audit log files")]
        [DefaultValue(false)]
        [ConfigurationEntry("Security.AuditLog.Compress", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.Certificate.Path", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [DefaultValue(false)]
        [ConfigurationEntry("Security.DoNotConsiderMemoryLockFailureAsCatastrophicError", ConfigurationEntryScope.ServerWideOrPerDatabase, isSecured: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.Certificate.Exec", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.Certificate.Load.Exec", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.Certificate.Renew.Exec", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.Certificate.Change.Exec", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [ConfigurationEntry("Security.Certificate.Exec.TimeoutInSec", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.MasterKey.Exec", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [DefaultValue(30)]
        [TimeUnit(TimeUnit.Seconds)]
        [ConfigurationEntry("Security.MasterKey.Exec.TimeoutInSec", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [ConfigurationEntry("Security.UnsecuredAccessAllowed", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.Certificate.Validation.Exec", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [DefaultValue(5)]
        [TimeUnit(TimeUnit.Seconds)]
        [ConfigurationEntry("Security.Certificate.Validation.Exec.TimeoutInSec", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.TlsCipherSuites", ConfigurationEntryScope.ServerWideOnly, isSecured: true)]
