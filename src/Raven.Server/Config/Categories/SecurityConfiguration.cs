...
namespace Raven.Server.Config.Categories
{
    public class SecurityConfiguration : ConfigurationCategory
    {
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.Certificate.Path", isServerWideOnly: true)]
        public string CertificatePath { get; set; }

        [Description("The (optional) password of the .pfx certificate file.")]
        [DefaultValue(null)]
        [ConfigurationEntry("Security.Certificate.Password", isServerWideOnly: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.ClusterCertificate.Path", isServerWideOnly: true)]
        public string ClusterCertificatePath { get; set; }

        [Description("The (optional) password of the .pfx cluster certificate file.")]
        [DefaultValue(null)]
        [ConfigurationEntry("Security.ClusterCertificate.Password", isServerWideOnly: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.Certificate.Exec", isServerWideOnly: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.Certificate.Arguments", isServerWideOnly: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.ClusterCertificate.Exec", isServerWideOnly: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.ClusterCertificate.Arguments", isServerWideOnly: true)]
        ...
        [DefaultValue(30000)]
        [ConfigurationEntry("Security.Certificate.Timeout", isServerWideOnly: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.MasterKey.Path", isServerWideOnly: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.MasterKey.Exec", isServerWideOnly: true)]
        ...
        [DefaultValue(null)]
        [ConfigurationEntry("Security.MasterKey.Arguments", isServerWideOnly: true)]
        ...
        [DefaultValue(30000)]
        [ConfigurationEntry("Security.MasterKey.Timeout", isServerWideOnly: true)]
        ...
        [ConfigurationEntry("Security.UnsecuredAccessAllowed", isServerWideOnly: true)]
