            ...
            JsonOperationContext.MemoryBuffer bufferToCopy, X509Certificate2 cert)
        {
            ...
            switch (result.DatabaseStatus)
            {
                ...
                case DatabasesLandlord.DatabaseSearchResult.Status.Database:
                    ...
                    {
                        var resultingTask = await Task.WhenAny(databaseLoadingTask, Task.Delay(ServerStore.DatabasesLandlord.DatabaseLoadTimeout));
            ...
            switch (header.Operation)
            {
                ...
                case TcpConnectionHeaderMessage.OperationTypes.Replication:
                    ...
                    {
                        //TODO: egor
                        throw new InvalidOperationException("Unknown operation for sharded database " + header.Operation);
                    }
