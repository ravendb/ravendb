...
public sealed class UpdateEmbeddingsGenerationCommand : UpdateEtlCommand<EmbeddingsGenerationConfiguration, AiConnectionString>
{
    public UpdateEmbeddingsGenerationCommand()
    {
        // for deserialization
    }

    public UpdateEmbeddingsGenerationCommand(long taskId, EmbeddingsGenerationConfiguration configuration, string databaseName, string uniqueRequestId) : base(taskId, configuration, EtlType.EmbeddingsGeneration, databaseName, uniqueRequestId)
    {
    ...
    public override void UpdateDatabaseRecord(DatabaseRecord record, long etag)
    {
        ...
        new DeleteOngoingTaskCommand(TaskId, OngoingTaskType.EmbeddingsGeneration, DatabaseName, null).UpdateDatabaseRecord(record, etag);
        new AddEmbeddingsGenerationCommand(Configuration, DatabaseName, null).UpdateDatabaseRecord(record, etag);
    }
