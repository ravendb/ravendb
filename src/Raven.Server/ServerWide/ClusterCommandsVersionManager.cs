...
namespace Raven.Server.ServerWide
{
    public static class ClusterCommandsVersionManager
    {
        ...
        public static readonly IReadOnlyDictionary<string, int> ClusterCommandsVersions = new Dictionary<string, int>
        {
            ...
            [nameof(InstallUpdatedServerCertificateCommand_V2)] = 40_006,
            [nameof(ConfirmReceiptServerCertificateCommand_V2)] = 40_006,
            [nameof(RecheckStatusOfServerCertificateCommand_V2)] = 40_006,
            [nameof(ConfirmServerCertificateReplacedCommand_V2)] = 40_006,
            [nameof(RecheckStatusOfServerCertificateReplacementCommand_V2)] = 40_006,
