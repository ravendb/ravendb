...
namespace Raven.Server.ServerWide
{
    public class JsonDeserializationCluster : JsonDeserializationBase
    {
        ...
        public static Dictionary<string, Func<BlittableJsonReaderObject, CommandBase>> Commands = new Dictionary<string, Func<BlittableJsonReaderObject, CommandBase>>
        {
            ...
            [nameof(UpdatePullReplicationAsEdgeCommand)] = GenerateJsonDeserializationRoutine<UpdatePullReplicationAsEdgeCommand>(),
            [nameof(UpdatePullReplicationAsCentralCommand)] = GenerateJsonDeserializationRoutine<UpdatePullReplicationAsCentralCommand>(),
