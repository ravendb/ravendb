...
public class PeriodicBackupStatusReport : IDynamicJson
{
    ...
    public static PeriodicBackupStatusReport Deserialize(BlittableJsonReaderObject backupStatus)
    {
        ...
        if (backupStatus.TryGet(nameof(PeriodicBackupStatus.LastFullBackup), out DateTime? lastSuccessfulFullBackupTime))
            statusReport.LastSuccessfulFullBackupTime = lastSuccessfulFullBackupTime;
    ...
    {
        if (LastSuccessfulFullBackupTime != null)
            return true;
