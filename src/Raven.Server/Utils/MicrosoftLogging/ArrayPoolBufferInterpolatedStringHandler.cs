...
namespace Raven.Server.Utils.MicrosoftLogging
{
    ...
    public ref struct ArrayPoolBufferInterpolatedStringHandlerInfo
    {
        private ArrayPoolBufferInterpolatedStringHandler _inner;

        public ArrayPoolBufferInterpolatedStringHandlerInfo(int literalLength, int formattedCount, Logger logger, Span<char> initBuffer,out bool shouldLog)
        {
            ...
            _inner = new ArrayPoolBufferInterpolatedStringHandler(literalLength, formattedCount, null, initBuffer);
            shouldLog = true;
        }
        
        public ArrayPoolBufferInterpolatedStringHandlerInfo(int literalLength, int formattedCount, Logger logger, out bool shouldLog)
        {
            if (logger.IsInfoEnabled == false)
            {
                shouldLog = false;
            ...
            _inner = new ArrayPoolBufferInterpolatedStringHandler(literalLength, formattedCount);
            shouldLog = true;
        }
        ...
        internal ArraySegment<char> Text => _inner.Text;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal void Clear() => _inner.Clear();
    }
    
    public ref struct ArrayPoolBufferInterpolatedStringHandler
    {
        private const uint MaxStringLength = 2 ^ 31;
        ...
        public ArrayPoolBufferInterpolatedStringHandler(int literalLength, int formattedCount)
        {
            _provider = null;
        ...
        /// <remarks>This is intended to be called only by compiler-generated code. Arguments are not validated as they'd otherwise be for members intended to be used directly.</remarks>
        public ArrayPoolBufferInterpolatedStringHandler(int literalLength, int formattedCount, IFormatProvider? provider)
        {
            _provider = provider;
            _chars = _arrayToReturnToPool = ArrayPool<char>.Shared.Rent(GetDefaultLength(literalLength, formattedCount));
            _pos = 0;
        ...
        /// <remarks>This is intended to be called only by compiler-generated code. Arguments are not validated as they'd otherwise be for members intended to be used directly.</remarks>
        public ArrayPoolBufferInterpolatedStringHandler(int literalLength, int formattedCount, IFormatProvider? provider, Span<char> initialBuffer)
        {
            _provider = provider;
        ...
        // internal ArraySegment<char> Text => new ArraySegment<char>(_chars.Slice(0, _pos));
        internal ArraySegment<char> Text => new ArraySegment<char>(_arrayToReturnToPool, 0, _pos);
        ...
        public void AppendLiteral(string value)
        {
            ...
            //     {
            //         // value.CopyTo(0, _chars, _pos, value.Length);
            //         
