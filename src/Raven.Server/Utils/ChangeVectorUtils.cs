...
namespace Raven.Server.Utils
{
    ...
    public class ChangeVector
    {
        ...
        public ConflictStatus GetConflictStatusForVersion(ChangeVector other) => GetConflictStatusInternal(Version, other.Version);

        public ConflictStatus GetConflictStatusForOrder(ChangeVector other) => GetConflictStatusInternal(Order, other.Order);
        ...
        public static ChangeVector Merge(ChangeVector cv1, ChangeVector cv2)
        {
            ...
            if (cv1._changeVector != null && cv2._changeVector != null)
            {
