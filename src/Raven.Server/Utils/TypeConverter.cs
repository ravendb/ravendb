...
namespace Raven.Server.Utils
{
    internal static class TypeConverter
    {
        ...
        public static IPropertyAccessor GetPropertyAccessorForMapReduceOutput(object value, HashSet<Raven.Server.Documents.Indexes.Static.Roslyn.Rewriters.Field> groupByFields)
        {
            var type = value.GetType();
