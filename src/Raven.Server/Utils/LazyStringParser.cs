...
namespace Raven.Server.Utils
{
    ...
    public unsafe class LazyStringParser
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool TryParseNumber2(char* ptr, out int val)
        {
            if (ptr[0] < '0' || ptr[0] > '9' || ptr[1] < '0' || ptr[1] > '9')
                goto Failed;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool TryParseNumber3(char* ptr, out int val)
        {
            if (ptr[0] < '0' || ptr[0] > '9' || ptr[1] < '0' || ptr[1] > '9' || ptr[2] < '0' || ptr[2] > '9')
                goto Failed;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool TryParseNumber4(char* ptr, out int val)
        {
            if (ptr[0] < '0' || ptr[0] > '9' || ptr[1] < '0' || ptr[1] > '9' || ptr[2] < '0' || ptr[2] > '9' || ptr[3] < '0' || ptr[3] > '9')
                goto Failed;
