...
namespace Raven.Server.Utils.Imports.Memory
{
    internal sealed partial class CacheEntry : ICacheEntry
    {
        ...
        {
            if (EvictionReason == Microsoft.Extensions.Caching.Memory.EvictionReason.None)
            {
        ...
        private bool CheckForExpiredTime(in DateTimeOffset now)
        {
            ...
            bool FullCheck(in DateTimeOffset offset)
            {
                ...
                {
                    SetExpired(Microsoft.Extensions.Caching.Memory.EvictionReason.Expired);
                    return true;
                }
        ...
        private static void ExpirationTokensExpired(object obj)
        {
            ...
            Task.Factory.StartNew(state =>
            {
                ...
                entry.SetExpired(Microsoft.Extensions.Caching.Memory.EvictionReason.TokenExpired);
