...
namespace Raven.Server.Json
{
    internal static class BlittableJsonTextWriterExtensions
    {
        ...
        public static void WriteSuggestionsQueryResult(this BlittableJsonTextWriter writer, JsonOperationContext context, SuggestionsQueryResultServerSide result)
        {
            writer.WriteStartObject();
