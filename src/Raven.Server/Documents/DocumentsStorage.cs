...
namespace Raven.Server.Documents
{
    public unsafe partial class DocumentsStorage : IDisposable
    {
        ...
        public IEnumerable<Document> GetDocuments(DocumentsOperationContext context, IEnumerable<Slice> ids, long start, long take, Reference<long> totalCount)
            => GetDocuments<Document>(context, ids, start, take, totalCount);
        
        public IEnumerable<TDocument> GetDocuments<TDocument>(DocumentsOperationContext context, IEnumerable<Slice> ids, long start, long take, Reference<long> totalCount)
            where TDocument : Document, new()
        {
            var table = new Table(DocsSchema, context.Transaction.InnerTransaction);
        ...
        public IEnumerable<TDocument> GetDocuments<TDocument>(DocumentsOperationContext context, IEnumerable<string> ids, long start, long take, Reference<long> totalCount)
            where TDocument : Document, new()
        {
            ...
            return GetDocuments<TDocument>(context, listOfIds, start, take, totalCount);
        }
        ...
        public IEnumerable<Document> GetDocumentsForCollection(DocumentsOperationContext context, IEnumerable<Slice> ids, string collection, long start, long take, Reference<long> totalCount) 
            => GetDocumentsForCollection<Document>(context, ids, collection, start, take, totalCount);
        
        public IEnumerable<TDocument> GetDocumentsForCollection<TDocument>(DocumentsOperationContext context, IEnumerable<Slice> ids, string collection, long start, long take, Reference<long> totalCount)
            where TDocument : Document, new()
        {
