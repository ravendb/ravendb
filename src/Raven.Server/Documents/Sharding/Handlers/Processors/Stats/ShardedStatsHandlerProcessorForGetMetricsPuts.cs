...
{
    internal sealed class ShardedStatsHandlerProcessorForGetMetricsPuts : AbstractStatsHandlerProcessorForGetMetricsPuts<ShardedDatabaseRequestHandler, TransactionOperationContext>
    {
