...
{
    internal sealed class ShardedStatsHandlerProcessorForGetMetricsBytes : AbstractStatsHandlerProcessorForGetMetricsBytes<ShardedDatabaseRequestHandler, TransactionOperationContext>
    {
