...
{
    internal class ShardedStatsHandlerProcessorForGetMetricsBytes : AbstractStatsHandlerProcessorForGetMetricsBytes<ShardedDatabaseRequestHandler, TransactionOperationContext>
    {
