...
{
    internal sealed class ShardedRevisionsHandlerProcessorForGetRevisionsConfiguration : AbstractRevisionsHandlerProcessorForGetRevisionsConfiguration<ShardedDatabaseRequestHandler>
    {
