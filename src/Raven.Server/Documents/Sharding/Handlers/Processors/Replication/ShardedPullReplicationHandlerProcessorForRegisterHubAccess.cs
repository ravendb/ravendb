...
{
    internal sealed class ShardedPullReplicationHandlerProcessorForRegisterHubAccess : AbstractPullReplicationHandlerProcessorForRegisterHubAccess<ShardedDatabaseRequestHandler, TransactionOperationContext>
    {
