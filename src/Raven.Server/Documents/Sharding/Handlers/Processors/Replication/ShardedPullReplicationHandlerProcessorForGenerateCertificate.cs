...
{
    internal sealed class ShardedPullReplicationHandlerProcessorForGenerateCertificate : AbstractPullReplicationHandlerProcessorForGenerateCertificate<ShardedDatabaseRequestHandler>
    {
