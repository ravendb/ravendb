...
{
    internal sealed class ShardedOngoingTasksHandlerProcessorForToggleTaskState : AbstractOngoingTasksHandlerProcessorForToggleTaskState<ShardedDatabaseRequestHandler, TransactionOperationContext>
    {
