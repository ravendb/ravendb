...
{
    internal sealed class ShardedDocumentsCompressionHandlerProcessorForGet : AbstractDocumentsCompressionHandlerProcessorForGet<ShardedDatabaseRequestHandler, TransactionOperationContext>
    {
