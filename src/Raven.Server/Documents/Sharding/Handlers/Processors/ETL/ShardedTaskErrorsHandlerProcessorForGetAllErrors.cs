...
internal sealed class ShardedTaskErrorsHandlerProcessorForGetAllErrors : AbstractTaskErrorsHandlerProcessorForGetAllErrors<ShardedDatabaseRequestHandler, TransactionOperationContext>
{
    public ShardedTaskErrorsHandlerProcessorForGetAllErrors([NotNull] ShardedDatabaseRequestHandler requestHandler) : base(requestHandler)
    {
    }
