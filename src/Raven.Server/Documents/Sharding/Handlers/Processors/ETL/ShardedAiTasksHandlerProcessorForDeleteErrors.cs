...
internal sealed class ShardedAiTasksHandlerProcessorForDeleteErrors : AbstractTaskErrorsHandlerProcessorForDeleteErrors<ShardedDatabaseRequestHandler, TransactionOperationContext>
{
    public ShardedAiTasksHandlerProcessorForDeleteErrors([NotNull] ShardedDatabaseRequestHandler requestHandler) : base(requestHandler)
    {
    }
