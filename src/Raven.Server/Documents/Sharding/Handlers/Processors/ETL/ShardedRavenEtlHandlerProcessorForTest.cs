...
{
    internal sealed class ShardedRavenEtlHandlerProcessorForTest : AbstractShardedEtlHandlerProcessorForTest<TestRavenEtlScript, RavenEtlConfiguration, RavenConnectionString>
    {
