...
internal sealed class ShardedAiTasksHandlerProcessorForGetErrors : AbstractTaskErrorsHandlerProcessorForGetErrors<ShardedDatabaseRequestHandler, TransactionOperationContext>
{
    public ShardedAiTasksHandlerProcessorForGetErrors([NotNull] ShardedDatabaseRequestHandler requestHandler) : base(requestHandler)
    {
    }
