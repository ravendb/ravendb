...
{
    [RavenShardedAction("/databases/*/admin/etl/ai/test-connection", "POST")]
    public async Task TestAiConnection()
    {
        ...
        using (var processor = new AiEtlHandlerProcessorForTestAiConnection<ShardedDatabaseRequestHandler, TransactionOperationContext>(this)
