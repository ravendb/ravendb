...
namespace Raven.Server.Documents.PeriodicBackup
{
    public class BackupStatusStorage
    {
        ...
        private readonly RavenLogger _logger = RavenLogManager.Instance.GetLoggerForServer<BackupStatusStorage>();
        ...
        public void Insert(PeriodicBackupStatus backupStatus, string databaseName)
        {
            ...
            if (_logger.IsDebugEnabled)
                _logger.Debug($"Inserted backup status for database '{databaseName}' with task ID {backupStatus.TaskId}.");
        }
