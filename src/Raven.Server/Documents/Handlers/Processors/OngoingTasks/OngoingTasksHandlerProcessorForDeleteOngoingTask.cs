...
{
    internal sealed class OngoingTasksHandlerProcessorForDeleteOngoingTask : AbstractOngoingTasksHandlerProcessorForDeleteOngoingTask<DatabaseRequestHandler, DocumentsOperationContext>
    {
