...
{
    internal class StatsHandlerProcessorForGetMetricsBytes : AbstractStatsHandlerProcessorForGetMetricsBytes<DatabaseRequestHandler, DocumentsOperationContext>
    {
