...
{
    internal abstract class AbstractTimeSeriesHandlerProcessorForGetTimeSeriesRanges<TRequestHandler, TOperationContext> : AbstractDatabaseHandlerProcessor<TRequestHandler, TOperationContext>
