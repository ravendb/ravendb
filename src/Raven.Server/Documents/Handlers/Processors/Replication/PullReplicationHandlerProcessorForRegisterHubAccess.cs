...
{
    internal sealed class PullReplicationHandlerProcessorForRegisterHubAccess : AbstractPullReplicationHandlerProcessorForRegisterHubAccess<DatabaseRequestHandler, DocumentsOperationContext>
    {
