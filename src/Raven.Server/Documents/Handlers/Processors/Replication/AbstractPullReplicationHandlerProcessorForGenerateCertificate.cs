...
namespace Raven.Server.Documents.Handlers.Processors.Replication
{
        ...
        where TRequestHandler : RequestHandler
    {
        ...
        public override async ValueTask ExecuteAsync()
        {
            ...
            var caCert = CertificateUtils.CreateCertificateAuthorityCertificate(commonNameValue + " CA", out var caSubjectName, log);
            CertificateUtils.CreateSelfSignedCertificateBasedOnPrivateKey(commonNameValue, caSubjectName, (caCert.GetExportableRsaPrivateKey(), caCert.GetRSAPublicKey()), true, false, notAfter, out var certBytes, log: log);
