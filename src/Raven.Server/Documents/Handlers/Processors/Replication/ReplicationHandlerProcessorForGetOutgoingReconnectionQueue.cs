...
{
    internal sealed class ReplicationHandlerProcessorForGetOutgoingReconnectionQueue : AbstractReplicationHandlerProcessorForGetOutgoingReconnectionQueue<DatabaseRequestHandler, DocumentsOperationContext>
    {
