...
{
    internal sealed class PullReplicationHandlerProcessorForDefineHub : AbstractPullReplicationHandlerProcessorForDefineHub<DatabaseRequestHandler, DocumentsOperationContext>
    {
