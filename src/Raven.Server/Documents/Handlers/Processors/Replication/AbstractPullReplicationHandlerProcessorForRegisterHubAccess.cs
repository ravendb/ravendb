...
{
    internal abstract class AbstractPullReplicationHandlerProcessorForRegisterHubAccess<TRequestHandler> : AbstractHandlerProcessorForUpdateDatabaseConfiguration<BlittableJsonReaderObject, TRequestHandler>
