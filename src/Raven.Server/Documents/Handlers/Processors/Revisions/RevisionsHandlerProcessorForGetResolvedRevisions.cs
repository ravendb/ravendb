...
{
    internal sealed class RevisionsHandlerProcessorForGetResolvedRevisions : AbstractRevisionsHandlerProcessorForGetResolvedRevisions<DatabaseRequestHandler, DocumentsOperationContext>
    {
