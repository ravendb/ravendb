...
internal class AiAgentProcessorForStartChat : AbstractAiAgentProcessor
{
    ...
    public override async ValueTask ExecuteAsync()
    {
        ...
        var conversationId = await TryPersistAsync(configuration, $"{name}{RequestHandler.Database.IdentityPartsSeparator}{configuration.Persistence.Collection}{RequestHandler.Database.IdentityPartsSeparator}", r.Document);
