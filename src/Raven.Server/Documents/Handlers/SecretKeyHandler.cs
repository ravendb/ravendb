...
namespace Raven.Server.Documents.Handlers
{
    public class SecretKeyHandler : RequestHandler
    {
        ...
        {
            using (var shortLived = RequestExecutor.CreateForSingleNodeWithoutConfigurationUpdates(url, name, server.Server.ClusterCertificateHolder.Certificate, DocumentConventions.Default))
            {
