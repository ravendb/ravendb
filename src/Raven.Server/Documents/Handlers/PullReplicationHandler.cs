...
#pragma warning restore CS0618 // Type or member is obsolete
                ...
                using var cert = CertificateUtils.CreateCertificate(Convert.FromBase64String(access.CertificateBase64));
        ...
        public async Task GeneratePullReplicationCertificate()
        {
            ...
            var certificateWithPrivateKey = CertificateUtils.CreateCertificate(certBytes, flags: CertificateUtils.FlagsForExport);
