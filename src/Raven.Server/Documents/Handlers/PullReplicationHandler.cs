...
#pragma warning restore CS0618 // Type or member is obsolete
                ...
                using var cert = CertificateLoaderUtil.CreateCertificate(Convert.FromBase64String(access.CertificateBase64));
        ...
        public async Task GeneratePullReplicationCertificate()
        {
            ...
            CertificateUtils.CreateSelfSignedCertificateBasedOnPrivateKey(commonNameValue, caSubjectName, ca, true, false, notAfter, out var certBytes, log: log);
            var certificateWithPrivateKey = CertificateLoaderUtil.CreateCertificate(certBytes, flags: CertificateLoaderUtil.FlagsForExport);
