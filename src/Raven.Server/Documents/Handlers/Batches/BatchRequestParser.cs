            ...
            CancellationToken token)
        {
            ...
            switch (commandData.Type)
            {
                ...
                case CommandType.PUT:
                    ...
                    commandData.CollectionName = CollectionName.GetCollectionName(commandData.Document);
                    commandData.Document.TryGet(Client.Constants.Documents.Metadata.Key, out commandData.Metadata);
                    break;
