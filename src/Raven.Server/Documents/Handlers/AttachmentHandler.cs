...
namespace Raven.Server.Documents.Handlers
{
    public class AttachmentHandler : DatabaseRequestHandler
    {
        ...
        [RavenAction("/databases/*/attachments/hash", "GET", AuthorizationStatus.ValidUser,isDebugInformationEndpoint:true)]
        public Task Exists()
        {
        ...
        [RavenAction("/databases/*/attachments/metadata", "GET", AuthorizationStatus.ValidUser, isDebugInformationEndpoint: true)]
