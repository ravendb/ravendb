                    ...
                    foreach (var item in _replicationInfo.ReplicatedItems)
                    {
                        ...
                        switch (item)
                        {
                            case AttachmentReplicationItem attachment:
                                ...
                                toDispose.Add(DocumentIdWorker.Compatibility.GetLowerIdSliceAndStorageKey(context, attachment.Name, out _, out Slice attachmentName));
                                toDispose.Add(DocumentIdWorker.Compatibility.GetLowerIdSliceAndStorageKey(context, attachment.ContentType, out _, out Slice contentType));
