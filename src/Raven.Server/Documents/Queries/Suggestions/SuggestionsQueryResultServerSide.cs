...
{
    public class SuggestionsQueryResult 
    {
    ...
    public class SuggestionsQueryResultServerSide : SuggestionsQueryResult
    {
        public static readonly SuggestionsQueryResultServerSide NotModifiedResult = new SuggestionsQueryResultServerSide { NotModified = true };
