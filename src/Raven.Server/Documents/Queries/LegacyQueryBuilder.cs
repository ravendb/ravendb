...
{
    public static class LegacyQueryBuilder
    {
        ...
        private static Query HandleMethods(Query query, Analyzer analyzer)
        {
        ...
        private static string PreProcessMixedInclusiveExclusiveRangeQueries(string query)
        {
            // First we should check if this query might match the regex because regex are expenssive...
