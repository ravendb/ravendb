...
namespace Raven.Server.Documents.Queries.Results.TimeSeries
{
        ...
        where TDocument : Document, new()
    {
        ...
        public TimeSeriesRetrieverBase.TimeSeriesStreamingRetrieverResult PrepareForStreaming(IEnumerable<DynamicJsonValue> array, bool addProjectionToResult,
            bool fromStudio)
        {
            var result = new TimeSeriesRetrieverBase.TimeSeriesStreamingRetrieverResult { Stream = array, Metadata = new DynamicJsonValue() };
