...
namespace Raven.Server.Documents.Queries
{
    ...
    {
        public static void ValidateCircle(List<object> arguments, string queryText, BlittableJsonReaderObject parameters)
        {
        ...
        public static void ValidateWkt(List<object> arguments, string queryText, BlittableJsonReaderObject parameters)
        {
        ...
        public static void ValidatePoint(List<object> arguments, string queryText, BlittableJsonReaderObject parameters)
        {
