...
namespace Raven.Server.Documents.Queries.AST
{
    public sealed class Query
    {
        ...
        public List<(QueryExpression Expression, OrderByFieldType FieldType, bool Ascending, bool? NullFirst)> OrderBy;
        ...
        public (string FunctionText, Acornima.Ast.Program Program, HashSet<string> ReferencedParameters) SelectFunctionBody;
        public string UpdateBody;
        public ValueExpression Offset;
        public ValueExpression Limit;
        public ValueExpression FilterLimit;

        public List<(QueryExpression Expression, OrderByFieldType FieldType, bool Ascending, bool? NullFirst)> CachedOrderBy;
    ...
    public sealed class DeclaredFunction
    {
        ...
        public Acornima.Ast.Program JavaScript;
