...
{
    public class ElasticSearchDocumentTransformerV8 : EtlTransformerV8<ElasticSearchItem, ElasticSearchIndexWithRecords, EtlStatsScope, EtlPerformanceOperation>
    {
        ...
        protected override void LoadToFunction(string indexName, ScriptRunnerResult<JsHandleV8> document)
        {
            if (indexName == null)
