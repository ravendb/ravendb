...
public class RabbitMqDocumentTransformerV8<T> : RabbitMqDocumentTransformerBase<T, JsHandleV8> where T : QueueItem 
{
    public RabbitMqDocumentTransformerV8(Transformation transformation, DocumentDatabase database, DocumentsOperationContext context, QueueEtlConfiguration config)
