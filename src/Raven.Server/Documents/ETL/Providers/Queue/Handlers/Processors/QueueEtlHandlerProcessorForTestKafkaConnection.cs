...
{
    internal class QueueEtlHandlerProcessorForTestKafkaConnection<TRequestHandler, TOperationContext> : AbstractDatabaseHandlerProcessor<TRequestHandler, TOperationContext>
