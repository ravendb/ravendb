...
{
    internal class QueueEtlHandlerProcessorForTestRabbitMqConnection<TRequestHandler, TOperationContext> : AbstractDatabaseHandlerProcessor<TRequestHandler, TOperationContext>
