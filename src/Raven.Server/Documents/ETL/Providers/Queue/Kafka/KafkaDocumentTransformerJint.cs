...
public class KafkaDocumentTransformerJint<T> : KafkaDocumentTransformerBase<T, JsHandleJint> where T : QueueItem
{
    public KafkaDocumentTransformerJint(Transformation transformation, DocumentDatabase database, DocumentsOperationContext context, QueueEtlConfiguration config)
