...
{
    public class OlapDocumentTransformerV8 : EtlTransformerV8<ToOlapItem, OlapTransformedItems, OlapEtlStatsScope, OlapEtlPerformanceOperation>
    {
        ...
        private JsHandleV8 _noPartition;
        ...
        protected override void LoadToFunction(string tableName, ScriptRunnerResult<JsHandleV8> colsAsObject)
        {
        }

        private void LoadToFunction(string tableName, string key, ScriptRunnerResult<JsHandleV8> runnerResult, List<string> partitions = null)
        {
            if (key == null)
        ...
        private JsHandleV8 LoadToFunctionTranslator(JsHandleV8 self, JsHandleV8[] args)
        {
        ...
        private JsHandleV8 LoadToFunctionTranslator(string name, JsHandleV8[] args)
        {
            var methodSignature = $"loadTo{name}(key, obj)";
        ...
        private JsHandleV8 LoadToFunctionTranslatorInternal(string name, JsHandleV8 key, JsHandleV8 obj, string methodSignature)
        {
            ...
            var result = new ScriptRunnerResultV8(DocumentScript, obj);
        ...
        private JsHandleV8 PartitionBy(JsHandleV8 self, JsHandleV8[] args)
        {
            if (args.Length == 0)
        ...
        private JsHandleV8 NoPartition(JsHandleV8 self, JsHandleV8[] args)
        {
            if (args.Length != 0)
