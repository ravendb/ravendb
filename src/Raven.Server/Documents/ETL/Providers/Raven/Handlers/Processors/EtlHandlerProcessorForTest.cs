...
{
    internal sealed class EtlHandlerProcessorForTest : AbstractDatabaseEtlHandlerProcessorForTest<TestRavenEtlScript, RavenEtlConfiguration, RavenConnectionString>
    {
