...
namespace Raven.Server.Documents.ETL.Providers.Raven
{
    public class RavenEtlDocumentTransformerJint : RavenEtlTransformerJint<RavenEtlItem, ICommandData, EtlStatsScope, EtlPerformanceOperation>
    {
        ...
        private JsHandleJint _addAttachmentMethod;
        private JsHandleJint _addCounterMethod;
        private JsHandleJint _addTimeSeriesMethod;

        public RavenEtlDocumentTransformerJint(Transformation transformation, DocumentDatabase database, DocumentsOperationContext context, ScriptInput script)
        ...
        {
            JsHandleJint? attachmentReference = null;
        ...
        private JsHandleJint AddCounter(JsHandleJint self, JsHandleJint[] args)
        {
            if (args.Length != 1)
        ...
        private JsHandleJint AddTimeSeries(JsHandleJint self, JsHandleJint[] args)
        {
        ...
        protected override void LoadToFunction(string collectionName, ScriptRunnerResult<JsHandleJint> document)
        {
