...
namespace Raven.Server.Documents.ETL.Providers.Raven
{
    public class RavenEtl : EtlProcess<RavenEtlItem, ICommandData, RavenEtlConfiguration, RavenConnectionString>
    {
        ...
        public override bool ShouldTrackCounters()
        {
            ...
            return Transformation.IsEmptyScript || Transformation.Counters.CollectionToLoadCounterBehaviorFunction != null;
        }
        ...
        public override bool ShouldTrackTimeSeries()
        {
            ...
            return Transformation.IsEmptyScript || Transformation.TimeSeries.CollectionToLoadTimeSeriesBehaviorFunction != null;
        }
