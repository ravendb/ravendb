...
namespace Raven.Server.Documents.Indexes.Static.JavaScript.V8
{
    public class AttachmentNameObjectInstanceV8 : ObjectInstanceBaseV8
    {
        ...
        {
            return _engine.CreateObjectBinder<AttachmentNameObjectInstanceV8.CustomBinder>(this, EngineEx.TypeBinderAttachmentNameObjectInstance, keepAlive: keepAlive);
        }
