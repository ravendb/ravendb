...
public class DatabaseWideMetrics : MetricsBase
{
    ...
    private static readonly Lazy<Meter> IndexesMeter = new(() => new Meter("mock1", "1.0.0"));
    private static readonly Lazy<Meter> DatabasesStorageMeter = new(() => new Meter("mock2", "1.0.0"));
    ...
    {
        if (Configuration.DatabasesEnabled == false)
            return;
    ...
    private void AddIndexIfNecessary(IndexChange change)
    {
        ...
        Task.Factory.StartNew(async () =>
        {
            ...
            try
            {
                ...
                if (Configuration.IndexesEnabled == false)
                    return;
    ...
    private void RegisterDatabaseStorageMetric()
    {
