...
public abstract class ActiveOngoingTasksBase : DatabaseBase<Integer32>
{
    ...
    protected static int GetNumberOfActiveAiEtls(RachisState rachisState, string nodeTag, RawDatabaseRecord database) => CountTasks(rachisState, nodeTag, database.Topology, database.AiEtls.Where(x => x.Disabled == false));
