...
namespace Raven.Server.Rachis
{
    public class RachisLogHistory
    {
        ...
        public void UpdateHistoryLogWithOriginalGuid(ClusterOperationContext context, long index, long term, BlittableJsonReaderObject cmd, object result, Exception exception)
        {
