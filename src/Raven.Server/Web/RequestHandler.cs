...
namespace Raven.Server.Web
{
    public abstract class RequestHandler
    {
        ...
        protected async Task PutCertificate(string prefix, bool includePrivateKey)
        {
        ...
        protected static void ValidateCertificateDefinition(CertificateDefinition certificate, ServerStore serverStore)
        {
        ...
        protected CertificateDefinition ReadCertificateFromCluster(TransactionOperationContext ctx, string key)
        {
