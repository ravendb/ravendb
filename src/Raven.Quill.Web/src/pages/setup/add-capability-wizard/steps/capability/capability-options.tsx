...
export const CAPABILITY_OPTIONS: RadioCardOption<"agent" | "embeddings" | "genai">[] = [
    {
        ...
        label: "AI Agent",
        description:
            "Conversational agent grounded in your live data source. System prompt + RQL tools. Deploy your agent to chosen channels.",
        icon: <MessageSquare className="size-5" />,
    },
    {
        value: "embeddings",
        label: "Embeddings generation",
        description: "Vector index over your data source. Collection + field selection for vectorisation.",
        disabled: true,
