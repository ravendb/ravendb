...
export function buildBackedHostPageSnippet(embedOrigin: string) {
    return [
        ...
        ...indent([
            ...
            "",
            "// Optional: pin the scheme at load by appending ?appearance=dark (or light/system) to the url,",
            "// e.g. `${url}?appearance=dark`. To follow your site's own light/dark toggle at runtime, send",
            '// "Light" or "Dark" whenever it changes, or "System" to follow the visitor\'s OS again:',
