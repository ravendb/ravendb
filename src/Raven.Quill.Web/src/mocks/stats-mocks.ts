...
export const sampleDashboardApps: ApplianceAppResponse[] = [
    {
        ...
        slug: "acme-shop",
        status: "running",
        source: { type: "PostgreSQL", connectionString: "", database: "shop" },
        tablesCount: 12,
    ...
    },
    {
        ...
        slug: "acme-support",
        status: "warning",
        source: { type: "MySQL", connectionString: "", database: "support" },
        tablesCount: 6,
    ...
    },
    {
        ...
        slug: "acme-warehouse",
        status: "loading",
        source: { type: "SQL Server", connectionString: "", database: "warehouse" },
        tablesCount: 0,
        documentsCount: 0,
        capabilitiesCount: 0,
        channelsCount: 0,
    ...
    },
    {
        ...
        slug: "acme-internal",
        status: "failed",
        source: { type: "PostgreSQL", connectionString: "", database: "internal" },
        tablesCount: 4,
