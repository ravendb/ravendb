...
function ChartTooltipContent({
    ...
    React.ComponentProps<"div"> & {
        ...
        // Drop series that are zero in the hovered bucket, so a stacked tooltip lists only the
        // series that actually contributed there instead of every series in the chart.
        hideZero?: boolean;
