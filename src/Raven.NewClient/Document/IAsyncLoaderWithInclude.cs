...
namespace Raven.NewClient.Client.Document
{
    ...
    public interface IAsyncLoaderWithInclude<T>
    {
        ...
        /// <returns></returns>
        Task<IDictionary<string, T>> LoadAsync(params string[] ids);
        ...
        /// <param name="ids">The ids.</param>
        /// <returns></returns>
        Task<IDictionary<string, T>> LoadAsync(IEnumerable<string> ids);
        ...
        /// Or whatever your conventions specify.
        /// </remarks>
        Task<IDictionary<string, T>> LoadAsync(params ValueType[] ids);
        ...
        /// Or whatever your conventions specify.
        /// </remarks>
        Task<IDictionary<string, T>> LoadAsync(IEnumerable<ValueType> ids);
        ...
        /// <param name="ids">The ids.</param>
        /// <returns></returns>
        Task<IDictionary<string, TResult>> LoadAsync<TResult>(params string[] ids);
        ...
        /// <param name="ids">The ids.</param>
        /// <returns></returns>
        Task<IDictionary<string, TResult>> LoadAsync<TResult>(IEnumerable<string> ids);
        ...
        /// Or whatever your conventions specify.
        /// </remarks>
        Task<IDictionary<string, TResult>> LoadAsync<TResult>(params ValueType[] ids);
        ...
        /// Or whatever your conventions specify.
        /// </remarks>
        Task<IDictionary<string, TResult>> LoadAsync<TResult>(IEnumerable<ValueType> ids);
    }
}
