...
namespace Raven.NewClient.Client.Document.Batches
{
    ...
    public interface ILazySessionOperations
    {
        ...
        Lazy<IDictionary<string, TResult>> Load<TResult>(IEnumerable<string> ids);
        ...
        Lazy<IDictionary<string, TResult>> Load<TResult>(IEnumerable<string> ids, Action<IDictionary<string, TResult>> onEval);
        ...
        ///     <para>Or whatever your conventions specify.</para>
        /// </summary>
        Lazy<IDictionary<string, TResult>> Load<TResult>(params ValueType[] ids);
        ...
        ///     <para>Or whatever your conventions specify.</para>
        /// </summary>
        Lazy<IDictionary<string, TResult>> Load<TResult>(IEnumerable<ValueType> ids);
        ...
        ///     <para>Or whatever your conventions specify.</para>
        /// </summary>
        Lazy<IDictionary<string, TResult>> Load<TResult>(IEnumerable<ValueType> ids, Action<IDictionary<string, TResult>> onEval);
        ...
        /// <param name="configure">additional configuration options for operation e.g. AddTransformerParameter</param>
        /// <param name="onEval">Action to be executed on evaluation.</param>
        Lazy<IDictionary<string, TResult>> Load<TTransformer, TResult>(IEnumerable<string> ids, Action<ILoadConfiguration> configure = null, Action<TResult> onEval = null) where TTransformer : AbstractTransformerCreationTask, new();
        ...
        /// <param name="configure">additional configuration options for operation e.g. AddTransformerParameter</param>
        /// <param name="onEval">Action to be executed on evaluation.</param>
        Lazy<IDictionary<string, TResult>> Load<TResult>(IEnumerable<string> ids, Type transformerType, Action<ILoadConfiguration> configure = null, Action<TResult> onEval = null);
        ...
        Lazy<IDictionary<string, TResult>> MoreLikeThis<TResult>(MoreLikeThisQuery query);
    }
    ...
    public interface IAsyncLazySessionOperations
    {
        ...
        Lazy<Task<IDictionary<string, TResult>>> LoadAsync<TResult>(IEnumerable<string> ids, CancellationToken token = default (CancellationToken));
        ...
        /// <param name="token">The cancellation token.</param>
        /// <param name="onEval">Action to be executed on evaluation.</param>
        Lazy<Task<IDictionary<string, TResult>>> LoadAsync<TResult>(IEnumerable<string> ids, Action<IDictionary<string, TResult>> onEval, CancellationToken token = default (CancellationToken));
        ...
        ///     <para>Or whatever your conventions specify.</para>
        /// </summary>
        Lazy<Task<IDictionary<string, TResult>>> LoadAsync<TResult>(CancellationToken token = default (CancellationToken),params ValueType[] ids);
        ...
        ///     <para>Or whatever your conventions specify.</para>
        /// </summary>
        Lazy<Task<IDictionary<string, TResult>>> LoadAsync<TResult>(IEnumerable<ValueType> ids, CancellationToken token = default (CancellationToken));
        ...
        ///     <para>Or whatever your conventions specify.</para>
        /// </summary>
        Lazy<Task<IDictionary<string, TResult>>> LoadAsync<TResult>(IEnumerable<ValueType> ids, Action<IDictionary<string, TResult>> onEval, CancellationToken token = default (CancellationToken));
        ...
        /// </param>
        /// <param name="token">The cancellation token.</param>
        Lazy<Task<IDictionary<string, TResult>>> LoadStartingWithAsync<TResult>(string keyPrefix, string matches = null, int start = 0, int pageSize = 25, string exclude = null, RavenPagingInformation pagingInformation = null, string skipAfter = null, CancellationToken token = default (CancellationToken));

        Lazy<Task<IDictionary<string, TResult>>> MoreLikeThisAsync<TResult>(MoreLikeThisQuery query, CancellationToken token = default (CancellationToken));
    }
