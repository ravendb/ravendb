...
namespace Raven.NewClient.Client.Document.Batches
{
    public class LazyMultiLoaderWithInclude<T> : ILazyLoaderWithInclude<T>
    {
        ...
        public Lazy<IDictionary<string, T>> Load(params string[] ids)
        {
        ...
        /// <param name="ids">The ids.</param>
        /// <returns></returns>
        public Lazy<IDictionary<string, T>> Load(IEnumerable<string> ids)
        {
        ...
        /// Or whatever your conventions specify.
        /// </remarks>
        public Lazy<IDictionary<string, T>> Load(params ValueType[] ids)
        {
        ...
        /// Or whatever your conventions specify.
        /// </remarks>
        public Lazy<IDictionary<string, T>> Load(IEnumerable<ValueType> ids)
        {
            var documentKeys = ids.Select(id => session.Conventions.FindFullDocumentKeyFromNonStringIdentifier(id, typeof(T), false));
            return Load(documentKeys);
        }
        ...
        /// <param name="ids">The ids.</param>
        public Lazy<IDictionary<string, TResult>> Load<TResult>(params string[] ids)
        {
        ...
        /// <param name="ids">The ids.</param>
        /// <returns></returns>
        public Lazy<IDictionary<string, TResult>> Load<TResult>(IEnumerable<string> ids)
        {
        ...
        public Lazy<IDictionary<string, TResult>> Load<TResult>(params ValueType[] ids)
        {
            var documentKeys = ids.Select(id => session.Conventions.FindFullDocumentKeyFromNonStringIdentifier(id, typeof(T), false));
            return Load<TResult>(documentKeys);
        }

        public Lazy<IDictionary<string, TResult>> Load<TResult>(IEnumerable<ValueType> ids)
        {
            var documentKeys = ids.Select(id => session.Conventions.FindFullDocumentKeyFromNonStringIdentifier(id, typeof(T), false));
            return Load<TResult>(documentKeys);
        }
    ...
    public class AsyncLazyMultiLoaderWithInclude<T> : IAsyncLazyLoaderWithInclude<T>
    {
        ...
        /// </summary>
        /// <param name="ids">The ids.</param>
        public Lazy<Task<IDictionary<string, T>>> LoadAsync(params string[] ids)
        {
        ...
        /// <param name="ids">The ids.</param>
        /// <returns></returns>
        public Lazy<Task<IDictionary<string, T>>> LoadAsync(IEnumerable<string> ids)
        {
        ...
        /// Or whatever your conventions specify.
        /// </remarks>
        public Lazy<Task<T>> LoadAsync(ValueType id)
        {
            var documentKey = session.Conventions.FindFullDocumentKeyFromNonStringIdentifier(id, typeof(T), false);
        ...
        /// Or whatever your conventions specify.
        /// </remarks>
        public Lazy<Task<IDictionary<string, T>>> LoadAsync(params ValueType[] ids)
        {
            var documentKeys = ids.Select(id => session.Conventions.FindFullDocumentKeyFromNonStringIdentifier(id, typeof(T), false));
        ...
        /// Or whatever your conventions specify.
        /// </remarks>
        public Lazy<Task<IDictionary<string, T>>> LoadAsync(IEnumerable<ValueType> ids)
        {
            var documentKeys = ids.Select(id => session.Conventions.FindFullDocumentKeyFromNonStringIdentifier(id, typeof(T), false));
            return LoadAsync(documentKeys);
        }
        ...
        /// <typeparam name="TResult"></typeparam>
        /// <param name="ids">The ids.</param>
        public Lazy<Task<IDictionary<string, TResult>>> LoadAsync<TResult>(params string[] ids)
        {
        ...
        /// <param name="ids">The ids.</param>
        /// <returns></returns>
        public Lazy<Task<IDictionary<string, TResult>>> LoadAsync<TResult>(IEnumerable<string> ids)
        {
        ...
        /// Or whatever your conventions specify.
        /// </remarks>
        public Lazy<Task<TResult>> LoadAsync<TResult>(ValueType id)
        {
            var documentKey = session.Conventions.FindFullDocumentKeyFromNonStringIdentifier(id, typeof(T), false);
            return LoadAsync<TResult>(documentKey);
        }

        public Lazy<Task<IDictionary<string, TResult>>> LoadAsync<TResult>(params ValueType[] ids)
        {
            var documentKeys = ids.Select(id => session.Conventions.FindFullDocumentKeyFromNonStringIdentifier(id, typeof(T), false));
            return LoadAsync<TResult>(documentKeys);
        }

        public Lazy<Task<IDictionary<string, TResult>>> LoadAsync<TResult>(IEnumerable<ValueType> ids)
        {
            var documentKeys = ids.Select(id => session.Conventions.FindFullDocumentKeyFromNonStringIdentifier(id, typeof(T), false));
            return LoadAsync<TResult>(documentKeys);
        }
