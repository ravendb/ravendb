...
namespace Raven.NewClient.Client.Document.Batches
{
    ...
    public interface ILazyLoaderWithInclude<T>
    {
        ...
        Lazy<IDictionary<string, T>> Load(params string[] ids);

        /// <summary>
        ///     Loads the specified entities with the specified ids.
        /// </summary>
        /// <param name="ids">Enumerable of Ids that should be loaded</param>
        Lazy<IDictionary<string, T>> Load(IEnumerable<string> ids);
        ...
        ///     <para>Or whatever your conventions specify.</para>
        /// </summary>
        Lazy<IDictionary<string, T>> Load(params ValueType[] ids);
        ...
        ///     <para>Or whatever your conventions specify.</para>
        /// </summary>
        Lazy<IDictionary<string, T>> Load(IEnumerable<ValueType> ids);

        /// <summary>
        ///     Loads the specified entities with the specified ids.
        /// </summary>
        /// <param name="ids">Enumerable of Ids that should be loaded</param>
        Lazy<IDictionary<string, TResult>> Load<TResult>(params string[] ids);
    ...
    public interface IAsyncLazyLoaderWithInclude<T>
    {
        ...
        /// </summary>
        /// <param name="ids">Enumerable of Ids that should be loaded</param>
        Lazy<Task<IDictionary<string, T>>> LoadAsync(params string[] ids);

        /// <summary>
        ///     Loads the specified entities with the specified ids.
        /// </summary>
        /// <param name="ids">Enumerable of Ids that should be loaded</param>
        Lazy<Task<IDictionary<string, T>>> LoadAsync(IEnumerable<string> ids);
        ...
        ///     <para>Or whatever your conventions specify.</para>
        /// </summary>
        Lazy<Task<IDictionary<string, T>>> LoadAsync(params ValueType[] ids);
        ...
        ///     <para>Or whatever your conventions specify.</para>
        /// </summary>
        Lazy<Task<IDictionary<string, T>>> LoadAsync(IEnumerable<ValueType> ids);

        /// <summary>
        ///     Loads the specified entities with the specified ids.
        /// </summary>
        /// <param name="ids">Enumerable of Ids that should be loaded</param>
        Lazy<Task<IDictionary<string, TResult>>> LoadAsync<TResult>(params string[] ids);

        /// <summary>
        ///     Loads the specified entities with the specified ids.
        /// </summary>
        /// <param name="ids">Enumerable of Ids that should be loaded</param>
        Lazy<Task<IDictionary<string, TResult>>> LoadAsync<TResult>(IEnumerable<string> ids);
        ...
        ///     <para>Or whatever your conventions specify.</para>
        /// </summary>
        Lazy<Task<IDictionary<string, TResult>>> LoadAsync<TResult>(params ValueType[] ids);
        ...
        ///     <para>Or whatever your conventions specify.</para>
        /// </summary>
        Lazy<Task<IDictionary<string, TResult>>> LoadAsync<TResult>(IEnumerable<ValueType> ids);
    }
}
