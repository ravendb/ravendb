...
{
    public sealed class GetServerWideBackupConfigurationOperation : IServerOperation<ServerWideBackupConfiguration>
    {
        ...
        private sealed class GetServerWideBackupConfigurationCommand : RavenCommand<ServerWideBackupConfiguration>
        {
            ...
            {
                url = $"{node.Url}/admin/configuration/server-wide/tasks?type={OngoingTaskType.Backup}&name={Uri.EscapeDataString(_name)}";
