...
namespace Raven.Client.Document.Batches
{
    ...
    public interface ILazySessionOperations
    {
        ...
        /// <param name="configure">additional configuration options for operation e.g. AddTransformerParameter</param>
        /// <param name="onEval">Action to be executed on evaluation.</param>
        Lazy<Dictionary<string, TResult>> Load<TTransformer, TResult>(IEnumerable<string> ids, Action<ILoadConfiguration> configure = null, Action<TResult> onEval = null) where TTransformer : AbstractTransformerCreationTask, new();
        ...
        /// <param name="configure">additional configuration options for operation e.g. AddTransformerParameter</param>
        /// <param name="onEval">Action to be executed on evaluation.</param>
        Lazy<Dictionary<string, TResult>> Load<TResult>(IEnumerable<string> ids, Type transformerType, Action<ILoadConfiguration> configure = null, Action<TResult> onEval = null);
        ...
        ///     null)
        /// </param>
        Lazy<Dictionary<string, TResult>> LoadStartingWith<TResult>(string keyPrefix, string matches = null, int start = 0, int pageSize = 25, string exclude = null, RavenPagingInformation pagingInformation = null, string skipAfter = null);
    ...
    public interface IAsyncLazySessionOperations
    {
        ...
        /// <param name="onEval">Action to be executed on evaluation.</param>
        /// <param name="token">Cancellation token</param>
        Lazy<Task<Dictionary<string, TResult>>> LoadAsync<TTransformer, TResult>(IEnumerable<string> ids, Action<ILoadConfiguration> configure = null, Action<TResult> onEval = null, CancellationToken token = default(CancellationToken)) where TTransformer : AbstractTransformerCreationTask, new();
        ...
        /// <param name="onEval">Action to be executed on evaluation.</param>
        /// <param name="token">Cancellation token</param>
        Lazy<Task<Dictionary<string, TResult>>> LoadAsync<TResult>(IEnumerable<string> ids, Type transformerType, Action<ILoadConfiguration> configure = null, Action<TResult> onEval = null, CancellationToken token = default(CancellationToken));
