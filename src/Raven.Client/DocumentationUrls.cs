...
internal static class DocumentationUrls
{
    internal static class Session
    {
        ...
        {
            ///<remarks><seealso href="https://ravendb.net/docs/article-page/7.0/csharp/document-extensions/revisions/overview#force-revision-creation"/></remarks>
    ...
    internal static class Operations
    {
        internal static class ServerOperations
        {
            ...
            {
                /// <remarks><seealso href="https://ravendb.net/docs/article-page/7.0/Csharp/indexes/using-analyzers#creating-custom-analyzers"/></remarks>
                public static string CustomAnalyzers => nameof(CustomAnalyzers);
            }
            
            internal static class Sorters
            {
                /// <remarks><seealso href="https://ravendb.net/docs/article-page/7.0/Csharp/client-api/operations/maintenance/sorters/put-sorter#put-custom-sorter"/></remarks>
                public static string CustomSorters = nameof(CustomSorters);
            }

            ///<remarks><seealso href="https://ravendb.net/docs/article-page/7.0/csharp/client-api/operations/maintenance/clean-change-vector"/></remarks>
            public static string UpdateUnusedDatabasesOperation = nameof(UpdateUnusedDatabasesOperation);
            
            ///<remarks><seealso href="https://ravendb.net/docs/article-page/7.0/Csharp/client-api/operations/maintenance/indexes/set-index-lock"/></remarks>
            public static string SetDatabasesLockOperation = nameof(SetDatabasesLockOperation);  
            
            ///<remarks><seealso href="https://ravendb.net/docs/article-page/7.0/Csharp/client-api/operations/server-wide/toggle-dynamic-database-distribution"/></remarks>
            public static string SetDatabaseDynamicDistributionOperation = nameof(SetDatabaseDynamicDistributionOperation);

            /// <remarks><seealso href="https://ravendb.net/docs/article-page/7.0/csharp/client-api/operations/server-wide/certificates/put-client-certificate"/></remarks>
            public static string PutClientCertificateOperation = nameof(PutClientCertificateOperation);

            /// <remarks><seealso href="https://ravendb.net/docs/article-page/7.0/csharp/client-api/operations/server-wide/certificates/delete-certificate"/></remarks>
            public static string DeleteCertificateOperation = nameof(DeleteCertificateOperation);

            /// <remarks><seealso href="https://ravendb.net/docs/article-page/7.0/csharp/client-api/operations/server-wide/configuration/put-serverwide-client-configuration"/></remarks>
            public static string PutServerWideClientConfiguration = nameof(PutServerWideClientConfiguration);

            /// <remarks><seealso href="https://ravendb.net/docs/article-page/7.0/Csharp/client-api/operations/server-wide/reorder-database-members"/></remarks>
    ...
    {
        /// <remarks><seealso href="https://ravendb.net/docs/article-page/7.0/csharp/server/configuration/logs-configuration"/></remarks>
        public static string LogsConfiguration = nameof(LogsConfiguration);

        /// <remarks><seealso href="https://ravendb.net/docs/article-page/7.0/csharp/server/configuration/traffic-watch-configuration"/></remarks>
