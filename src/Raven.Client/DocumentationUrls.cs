...
internal static class DocumentationUrls
{
    internal static class Session
    {
        internal static class Querying
        {
            ...
            /// <remarks><seealso href="https://ravendb.net/docs/article-page/6.0/Csharp/client-api/session/querying/debugging/query-timings"/></remarks>
            public const string QueryTimings = nameof(QueryTimings);

            /// <remarks><seealso href="https://ravendb.net/docs/article-page/6.0/csharp/client-api/session/querying/how-to-query#session.advanced.rawquery"/></remarks>
            public const string RawDocumentQuery = nameof(RawDocumentQuery);

            /// <remarks><seealso href="https://ravendb.net/docs/article-page/6.0/csharp/indexes/querying/projections#projection-behavior-with-a-static-index"/></remarks>
    ...
    internal static class Operations
    {
        internal static class ServerOperations
        {
            ...
            /// <remarks><seealso href="https://ravendb.net/docs/article-page/6.0/Csharp/client-api/operations/server-wide/reorder-database-members"/></remarks>
    ...
    internal static class Configuration
    {
        ...
        /// <remarks><seealso href="https://ravendb.net/docs/article-page/6.0/csharp/server/configuration/traffic-watch-configuration"/></remarks>
