...
namespace Raven.Client.Json.Serialization
{
    internal sealed class JsonDeserializationClient : JsonDeserializationBase
    {
        ...
        public static readonly Func<BlittableJsonReaderObject, DeleteRevisionsManuallyOperation.Result> DeleteRevisionsManuallyResult = GenerateJsonDeserializationRoutine<DeleteRevisionsManuallyOperation.Result>();
