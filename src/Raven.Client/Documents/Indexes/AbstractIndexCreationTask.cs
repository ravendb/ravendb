...
namespace Raven.Client.Documents.Indexes
{
    ...
    public abstract class AbstractIndexCreationTaskBase<TIndexDefinition> : AbstractCommonApiForIndexes, IAbstractIndexCreationTask where TIndexDefinition : IndexDefinition
    {
        ...
        public object LoadVector(string embeddingsGenerationTaskIdentifier, string path) => throw new NotSupportedException("This method is provided solely to allow query translation on the server");
