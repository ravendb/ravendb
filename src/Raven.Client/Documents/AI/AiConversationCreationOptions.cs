...
{
    /// <summary>
    /// A bag of named parameters required by the agent's tools (queries/actions)
    /// and used to initialize the conversation context.
    /// </summary>
    public Dictionary<string, object> Parameters { get; set; }

    /// <summary>
    /// Optional conversation expiration in seconds. When specified, the server
    /// may expire the conversation document after this interval.
    /// </summary>
