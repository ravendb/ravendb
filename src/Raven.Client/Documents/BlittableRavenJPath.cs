...
{
    public class BlittableRavenJPath
    {
        ...
        public BlittableRavenJPath(string expression)
        {
        ...
        internal object Evaluate(object root, bool errorWhenNoMatch, bool createSnapshots = false)
        {
            var current = root;
