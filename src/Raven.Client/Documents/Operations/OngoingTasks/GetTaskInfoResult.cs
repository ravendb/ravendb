...
namespace Raven.Client.Documents.Operations.OngoingTasks
{
    public enum OngoingTaskType
    {
        ...
        Backup,
        Subscription,
        PullReplicationAsCentral,
        PullReplicationAsEdge
    }
    ...
    public class OngoingTaskPullReplicationAsCentral : OngoingTask
    {
        public OngoingTaskPullReplicationAsCentral()
        {
            TaskType = OngoingTaskType.PullReplicationAsCentral;
        }
    ...
    public class OngoingTaskPullReplicationAsEdge : OngoingTask
    {
        public OngoingTaskPullReplicationAsEdge()
        {
            TaskType = OngoingTaskType.PullReplicationAsEdge;
        }
