...
{
    public class GetCompareExchangeOperation<T> : IOperation<CompareExchangeResult<T>>
    {
        ...
        private class GetCompareExchangeValueCommand : RavenCommand<CompareExchangeResult<T>>
        {
            private readonly string _key;
