...
#pragma warning restore 618
        ...
        private object TransformValue(WhereParams whereParams, bool forRange = false)
        {
            ...
            if (type == typeof(DateOnly))
                return ((DateOnly)whereParams.Value).ToString(Sparrow.DefaultFormat.TimeOnlyAndDateOnlyFormatToWrite, CultureInfo.InvariantCulture);
            if (type == typeof(TimeOnly))
                return ((TimeOnly)whereParams.Value).ToString(Sparrow.DefaultFormat.TimeOnlyAndDateOnlyFormatToWrite, CultureInfo.InvariantCulture);
#endif
