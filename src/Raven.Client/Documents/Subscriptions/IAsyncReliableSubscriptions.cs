...
namespace Raven.Client.Documents.Subscriptions
{
    public interface IAsyncReliableSubscriptions : IDisposable
    {
        ...
        Task<string> CreateAsync<T>(SubscriptionCreationOptions<T> subscriptionCreationParams, string database = null);
        ...
        /// </summary>
        /// <returns>Created subscription identifier.</returns>
        Task<string> CreateAsync(SubscriptionCreationOptions subscriptionCreationParams, string database = null);
