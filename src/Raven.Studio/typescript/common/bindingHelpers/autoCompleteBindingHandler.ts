...
class autoCompleteBindingHandler {
    ...
    init(element: HTMLElement, valueAccessor: () => string, allBindings: () => any) {
        ...
        input.on('keydown', (args: JQuery.TriggeredEvent) => this.handleKeyPress(element, $element, input, args));
    ...
    handleKeyPress(element: HTMLElement, $element: JQuery, $input: JQuery, args: JQuery.TriggeredEvent) {
        const enter = 13;
        const escape = 27;
        const downArrow = 40;
        const upArrow = 38;
