...
class treeBindingHandler {
    ...
    static loadNodeChildren(tree: string, node: DynaTreeNode, options: bindingOptions) {
        ...
        //TODO: new filesystem(appUrl.getFileSystemNameFromUrl(), true, false)
        var command = new getFoldersCommand(null, 0, 1024, dir); //TODO: pass fs using injection or remove fs specific code from this class
