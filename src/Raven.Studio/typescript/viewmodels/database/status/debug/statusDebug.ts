...
class statusDebug extends viewModelBase {
    ...
    constructor() {
        ...
        [
            ...
            { route: 'databases/status/debug/sqlReplication', moduleId: 'viewmodels/database/status/debug/statusDebugSqlReplication', title: 'SQL Replication', tooltip: "Shows information about SQL replication", nav: true, dynamicHash: appUrl.forCurrentDatabase().statusDebugSqlReplication },
            ...
            { route: 'databases/status/debug/persist', moduleId: 'viewmodels/database/status/debug/statusDebugPersistAutoIndex', title: 'Persist auto index', tooltip: "Persists auto index", nav: true, dynamicHash: appUrl.forCurrentDatabase().statusDebugPersistAutoIndex },
            { route: 'databases/status/debug/explainReplication', moduleId: 'viewmodels/database/status/debug/statusDebugExplainReplication', title: 'Explain replication', tooltip: "Shows information about replication of given document to given replication destination", nav: true, dynamicHash: appUrl.forCurrentDatabase().statusDebugExplainReplication },
        ];
