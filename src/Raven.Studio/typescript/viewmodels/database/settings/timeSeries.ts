        ...
        popoverUtils.longWithHover($(".aggregation-info"),
            {
                content: `
                         <small><br>
                             <ul>
                                 <li>
                                     <strong>A new time series</strong> is created by each Aggregation Policy defined.<br>
                                     Its name will be <code>&lt;Raw-data-time-series-name&gt;@&lt;Aggregation-policy-name&gt;</code>
                                  </li><br>
                                  <li>
                                 ...
                                 <li>
                                     The data generated by the first aggregation policy is based on the Raw time series data.<br>
                                     After that, input data for each aggregation policy is the data generated by the previous policy.
                                 </li><br>
                                 <li>
                                     <strong>Important</strong>:<br>
                                     Aggregated data is not created for time series that have entries with more than 5 values!<br>
        ...
        popoverUtils.longWithHover($(".named-values-info"),
            {
                content: `
                        <small>
                            <ul>
                                <li><strong>Associate names with your time series values</strong>.
                                </li><br>
                                <li>The default name per value is the value's position (i.e. <code>Value #0</code>)<br>
                                    Instead, values names can be customized.
                                </li><br>
                                <li><strong>For example</strong>: If time series tracks stock exchange data,<br>
