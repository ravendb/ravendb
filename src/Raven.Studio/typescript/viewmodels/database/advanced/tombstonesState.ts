    ...
    compositionComplete() {
        ...
        subscriptionsGrid.init(() => this.subscriptionsFetcher(), () => {
            return [
                ...
                new textColumn<SubscriptionInfo>(subscriptionsGrid, x => x.NumberOfTombstoneLeft, "Number of tombstone left", "10%", {
                    sortable: "string"
                }),
                new textColumn<SubscriptionInfo>(subscriptionsGrid, x => x.TombStoneTypes, "TombStoneTypes", "25%", {
                    sortable: "string"
                }),
                ...
                new textColumn<SubscriptionInfo>(subscriptionsGrid, x => x.BlockCleanup, "Blocking cleanup", "15%", {
                    sortable: "string"
                }),
            ]
        });
