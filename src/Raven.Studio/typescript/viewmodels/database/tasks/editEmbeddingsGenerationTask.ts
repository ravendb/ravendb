...
import aiConnectionStringUtils = require("components/pages/database/tasks/ongoingTasks/editTasks/editGenAiTask/partials/steps/EditGenAiTaskStepBasic");
...
class editEmbeddingsGenerationTask extends shardViewModelBase {
    ...
    testConnection() {
        ...
        new testAiConnectionStringCommand(this.db, aiConnectionStringUtils.getConnectorType(connectionString), connectionString.ModelType, aiConnectionStringUtils.mapAiConnectionStringToSettingsDto(connectionString))
            .execute()
