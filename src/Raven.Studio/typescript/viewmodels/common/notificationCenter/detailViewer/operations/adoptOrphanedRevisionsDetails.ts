...
class adoptOrphanedRevisionsDetails extends abstractOperationDetails {

    view = require("views/common/notificationCenter/detailViewer/operations/adoptOrphanedRevisionsDetails.html");

    progress: KnockoutObservable<Raven.Client.Documents.Operations.Revisions.AdoptOrphanedRevisionsResult>;
    ...
    initObservables() {
        ...
        this.progress = ko.pureComputed(() => {
            ...
            return progressResults as Raven.Client.Documents.Operations.Revisions.AdoptOrphanedRevisionsResult;
        });
    }
    ...
    static supportsDetailsFor(notification: abstractNotification) {
        return (notification instanceof operation) && notification.taskType() === "AdoptOrphanedRevisions";
    }

    static showDetailsFor(op: operation, center: notificationCenter) {
        return app.showBootstrapDialog(new adoptOrphanedRevisionsDetails(op, center));
    }
}

export = adoptOrphanedRevisionsDetails;
