...
class createDatabase extends dialogViewModelBase {
    ...
    protected initObservables() {
        ...
        this.disableSavingKeyData = ko.pureComputed(() => { 
            return !this.databaseModel.name() || !this.databaseModel.saveKeyValidationGroup.isValid();
    ...
    private keyDataText() : string {
        ...
        const databaseName = this.databaseModel.name();
    ...
    downloadEncryptionKey() {
        ...
        const textFileName = `Key-of-${this.databaseModel.name()}-${moment().format("YYYY-MM-DD-HH-mm")}.txt`;
    ...
    printEncryptionKey() {
        ...
        const docTitle = `Key-of-${this.databaseModel.name()}-${moment().format("YYYY-MM-DD-HH-mm")}.txt`;
