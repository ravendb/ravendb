...
export default class MockDatabasesService extends AutoMockService<DatabasesService> {
    ...
    withRemoteAttachmentsConfiguration(dto?: MockedValue<Raven.Client.Documents.Attachments.RemoteAttachmentsConfiguration>) {
        return this.mockResolvedValue(this.mocks.getRemoteAttachmentsConfiguration, dto, DatabasesStubs.remoteAttachmentsConfiguration());
    }
}
