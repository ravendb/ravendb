...
source files of the provided Software, all for your own internal commercial purposes,
...
For the sake of clarity it is hereby clarified that for as long as you have effective
license key, you may switch or upgrade to a new released version for no additional
charge, however if such new version comprises additional features that were
not available to you under the current version, then you will be required to pay
the applicable prices under the Buy Page in order to use such new features.
Once your license key expires and you choose not to renew the subscription period,
then you shall no longer be entitled to use RavenDB software under the terms
of this EULA and must delete the software from your servers or otherwise
use it under the terms of the AGPLv3 license, as mentioned above. 


Notwithstanding anything to the contrary in the foregoing paragraph, 
you may host the Software on behalf of your end users solely in conjunction with your 
applications; provided that yours' end users shall not, at any time, access the Software
directly, without a written consent of the Licensor.
For the avoidance of all doubt, if you use a developer license you may be required
to manually renew your license every 6 months (or such other period determined by Licensor),
and manually obtain the applicable certificates for the new period. 
...
from time to time.
Licensor may modify the price, content, or nature of the offered subscriptions
at any time. Licensor may provide notice of any such changes by email,
notice to you upon log-in, or by publishing them on the Site.
Licensor may change the fees and charges in effect or add new fees
and charges from time to time to offered subscriptions.
...
Hibernating Rhinos Ltd provides support for customer who purchased the support options
shown at: https://ravendb.net/support. Any support will be provided  pursuant to 
the Support Policy which is incorporated by reference into this EULA and which may be 
...
RIGHT OF PUBLICITY. Licensee expressly and irrevocably grants and permits the Licensor 
with the right to use its business name, logo and trademarks for display and show by Licensor 
on HR’s webpages or in any other medium. Licensee further agrees to allow Licensor to use its 
name, logo and URL on other advertisements, promotional materials and related collateral ("Marketing Uses"), 
including without limitation, for the purpose of demonstrating the usage of the Software 
by Licensee on its systems.
