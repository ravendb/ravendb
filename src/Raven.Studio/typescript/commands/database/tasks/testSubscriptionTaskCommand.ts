...
class testSubscriptionTaskCommand extends commandBase {
    ...
    constructor(private db: database | string, private payload: Raven.Client.Documents.Subscriptions.ISubscriptionCreationOptions & { Query?: string }, private resultsLimit: number, private timeLimit: number) {
        super();
    }
