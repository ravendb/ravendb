...
class deleteTimeSeriesCommand extends commandBase {
    constructor(private documentId: string, private name: string, private dtos: Raven.Client.Documents.Operations.TimeSeries.TimeSeriesOperation.DeleteOperation[], private db: database | string) {
        super();
    }
