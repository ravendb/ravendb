...
class registerSsoUserEntryCommand extends commandBase {

    constructor(private dto: certificatesTypes.RegisterSsoUserEntryDto) {
        super();
    }
...
export = registerSsoUserEntryCommand;
