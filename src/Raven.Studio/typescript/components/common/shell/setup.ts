...
import setupShell from "viewmodels/wizard/setupShell";
...
function initRedux() {
    ...
    setupShell.buildInfo.serverBuildVersion.subscribe((version) =>
        globalDispatch(clusterActions.serverVersionLoaded(version))
    );
