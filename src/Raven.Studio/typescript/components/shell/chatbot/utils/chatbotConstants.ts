...
const endpointsWhitelist: EndpointEntry[] = [
    ...
    { path: "/databases/{database}/revisions/resolved" },
    ...
    { path: "/databases/{database}/timeseries/ranges" },
    ...
    { path: "/databases/{database}/debug/queries/running" },
    ...
    { path: "/databases/{database}/admin/connection-strings" },
    ...
    { path: "/databases/{database}/replication/conflicts" },
    ...
    { path: "/admin/debug/node/clear-http-clients-pool" },
    ...
    { path: "/topology" },
    { path: "/databases/{database}/timeseries" },
    { path: "/databases/{database}/counters" },
