...
export default function StudioSearch() {
    ...
    return (
        <Dropdown isOpen={isSearchDropdownOpen} toggle={toggleDropdown} ref={refs.dropdownRef} className="omnisearch">
            <DropdownToggle className="omnisearch__toggle">
                ...
                <DropdownMenu className="omnisearch__results">
                    <Row className="m-0">
                        <Col sm={12} md={matchStatus.hasServerMatch ? 8 : 12} className="omnisearch__database-col p-0">
