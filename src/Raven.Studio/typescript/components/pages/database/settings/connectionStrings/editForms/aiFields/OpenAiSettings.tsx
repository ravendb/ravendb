            ...
            <div className="mb-2">
                <Label>
                    ...
                    <PopoverWithHoverWrapper
                        message={
                            <>
                                The value to use for the <code>OpenAI-Organization</code> request header. Users who
                                belong to multiple organizations can set this value to specify which organization is
                                used for an API request. Usage from these API requests will count against the specified
                                organization&apos;s quota. If not set, the header will be omitted, and the default
                                organization will be billed. You can change your default organization in your user
                                settings.
                                <br />
            ...
            <div className="mb-2">
                <Label>
                    ...
                    <PopoverWithHoverWrapper
                        message={
                            <>
                                The value to use for the <code>OpenAI-Project</code> request header. Users who are
                                accessing their projects through their legacy user API key can set this value to specify
                                which project is used for an API request. Usage from these API requests will count as
                                usage for the specified project. If not set, the header will be omitted, and the default
                                project will be accessed.
                            </>
                        }
                    >
