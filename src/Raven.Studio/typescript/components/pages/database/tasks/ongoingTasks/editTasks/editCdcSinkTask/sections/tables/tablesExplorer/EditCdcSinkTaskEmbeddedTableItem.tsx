...
import { ExplorerRowEmbeddedTable } from "components/pages/database/tasks/ongoingTasks/editTasks/editCdcSinkTask/utils/editCdcSinkTaskTypes";
...
export function EditCdcSinkTaskEmbeddedTableItem({
    path,
    table,
    depth,
    hasChildren,
