        ...
        <div className="sample-data absolute-fill">
            ...
            <div className="scroll">
                <div className="center">
                        ...
                        <div className="margin-top margin-bottom-sm">
                            ...
                            {isSampleDataCreated && (
                                <div className="padding padding-xs margin-top-sm">
                                    ...
                                    {/* TODO: Make the URL go to the Documents page */}
                                </div>
                            )}
                        </div>
                    ...
                    <Collapse isOpen={isCodeSampleOpen} id="cSharpClasses">
                        <Card className="sample-code">
                            <CardBody>
                                <CardHeader className="sample-code-header">
                                    ...
                                    {/* TODO: Add functionality to the button, make sure the toast notification is displayed*/}
                                </CardHeader>
                                <pre className="sample-code-classes margin-top">abc</pre>
                                {/* TODO: Generate C# classes properly; connect syntax coloring */}
                            </CardBody>
                        </Card>
                    </Collapse>
                </div>
