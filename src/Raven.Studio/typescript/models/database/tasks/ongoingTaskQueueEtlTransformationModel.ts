...
class ongoingTaskQueueEtlTransformationModel {
    ...
    static isApplyToAll(colectionName: string){
        return colectionName === ongoingTaskQueueEtlTransformationModel.applyToAllCollectionsText;
    }
    ...
    static empty(name?: string): ongoingTaskQueueEtlTransformationModel {
        return new ongoingTaskQueueEtlTransformationModel(
            {
    ...
    addWithBlink(collectionName: string) {
        if (ongoingTaskQueueEtlTransformationModel.isApplyToAll(collectionName)) {
...
export = ongoingTaskQueueEtlTransformationModel;
