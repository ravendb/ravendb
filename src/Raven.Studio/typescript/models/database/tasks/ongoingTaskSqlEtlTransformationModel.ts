...
class ongoingTaskSqlEtlTransformationModel {
    ...
    static isApplyToAll(colectionName: string){
        return colectionName === ongoingTaskSqlEtlTransformationModel.applyToAllCollectionsText;
    }
    ...
    addWithBlink(collectionName: string): void {
        if (ongoingTaskSqlEtlTransformationModel.isApplyToAll(collectionName)) {
