...
import { OrderByNullsContext } from "./BaseRqlParser";
...
export interface BaseRqlParserVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by `BaseRqlParser.orderByNulls`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitOrderByNulls?: (ctx: OrderByNullsContext) => Result;
