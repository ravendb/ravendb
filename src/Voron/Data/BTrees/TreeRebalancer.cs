    ...
    public sealed unsafe class TreeRebalancer
    {
        ...
        public TreePage Execute(TreePage page)
        {
            using (DisableFreeSpaceUsageIfSplittingRootTree())
            {
                ...
                if (page.UseMoreSizeThan((int)(Paging.PageMaxSpace * 0.33)) && page.NumberOfEntries >= minKeys) // temp code, merge toward main
                ...
                if (sibling.UseMoreSizeThan((int)(Paging.PageMaxSpace * 0.33)) && // temp code, merge toward main
