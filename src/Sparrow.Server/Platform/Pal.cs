...
namespace Sparrow.Server.Platform
{
    ...
    {
        public const int PAL_VER = 70886; // Should match auto generated rc from rvn_get_pal_ver() @ src/rvngetpalver.c
        ...
        [DllImport(LIBRVNPAL, SetLastError = true)]
        public static extern PalFlags.FailCodes rvn_pager_get_next_sparse_region(
            void* handle,
            Int64 offset,
            out Int64 start,
            out Int64 size,
