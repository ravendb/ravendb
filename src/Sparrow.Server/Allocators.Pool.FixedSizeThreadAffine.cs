...
namespace Sparrow.Server
{
    ...
    public static class FixedSizeThreadAffinePoolAllocator
    {
        ...
        public struct DefaultAcceptArbitrarySize : IFixedSizeThreadAffinePoolOptions, INativeOptions
        {
            public bool UseSecureMemory => false;
            public bool ElectricFenceEnabled => false;
            public bool Zeroed => false;
            ...
            public IAllocatorComposer<Pointer> CreateAllocator()
            {
                var allocator = new Allocator<NativeAllocator<DefaultAcceptArbitrarySize>>();
                allocator.Initialize(default(DefaultAcceptArbitrarySize));
                return allocator;
            }
