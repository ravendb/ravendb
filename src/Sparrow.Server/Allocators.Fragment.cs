...
namespace Sparrow.Server
{
        ...
        where TOptions : struct, IFragmentAllocatorOptions
    {
        ...
        public void Initialize(ref FragmentAllocator<TOptions> allocator)
        {
            ...
            allocator._internalPartialReusedSegments = new SortedList<int, Pointer>(new InverseDuplicateKeyComparer<int>());
        ...
        public class InverseDuplicateKeyComparer<TKey> : IComparer<TKey> where TKey : IComparable
        {
