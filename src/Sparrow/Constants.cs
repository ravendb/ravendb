...
namespace Sparrow.Global
{
    internal static class Constants
    {
        ...
        internal class Logging
        {
            ...
            internal const string DefaultLayout = "${longdate:universalTime=true}|${nodeTag}|${level:uppercase=true}|${threadid}|${event-properties:item=Resource}|${event-properties:item=Component}|${logger}|${message:withexception=true}|${event-properties:item=Data}";
