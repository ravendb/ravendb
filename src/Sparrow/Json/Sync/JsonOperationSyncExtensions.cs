...
namespace Sparrow.Json.Sync
{
    internal static class JsonOperationSyncExtensions
    {
        ...
        public static BlittableJsonReaderObject ReadForMemory(JsonOperationContext.SyncJsonOperationContext syncContext, Stream stream, string documentId)
        {
...
#endif
        internal static BlittableJsonReaderObject ParseToMemory(JsonOperationContext.SyncJsonOperationContext syncContext, Stream stream, string debugTag, BlittableJsonDocumentBuilder.UsageMode mode, IBlittableDocumentModifier modifier = null)
        {
#if DEBUG
        ...
        public static BlittableJsonReaderObject ParseToMemory(
            JsonOperationContext.SyncJsonOperationContext syncContext,
            Stream stream,
            string debugTag,
