...
namespace Sparrow.LowMemory
{
    public static class MemoryInformation
    {
        ...
        public static bool IsAddrResidentInPhysicalRam(IntPtr addr, long length) => PlatformDetails.RunningOnPosix ? PosixMemoryQueryMethods.IsMemoryResident(addr, length) : Win32MemoryQueryMethods.IsMemoryResident(addr, length);
    }
