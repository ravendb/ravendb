...
namespace Sparrow
{
    public static class PosixThreadsMethods
    {
        ...
        public static unsafe extern int pthread_setschedparam(IntPtr thread, int policy, sched_param* param);

        [DllImport(LIBC_6, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode, SetLastError = true)]
        public static unsafe extern int pthread_getschedparam(IntPtr thread, int* policy, sched_param* param);
