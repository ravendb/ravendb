...
namespace Sparrow.Platform.Posix
{
    public static unsafe class PosixSodium
    {
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_generichash_bytes() : X86.crypto_generichash_bytes()) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_generichash_statebytes() : X86.crypto_generichash_statebytes()) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_generichash_keybytes() : X86.crypto_generichash_keybytes()) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_kx_keypair(pk, sk) : X86.crypto_kx_keypair(pk, sk)) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_kdf_keybytes() : X86.crypto_kdf_keybytes()) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_stream_xchacha20_keybytes() : X86.crypto_stream_xchacha20_keybytes()) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_stream_xchacha20_noncebytes() : X86.crypto_stream_xchacha20_noncebytes()) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_aead_chacha20poly1305_encrypt_detached(c, mac, maclen_p, m, mlen, ad, adlen, nsec, npub, k) : X86.crypto_aead_chacha20poly1305_encrypt_detached(c, mac, maclen_p, m, mlen, ad, adlen, nsec, npub, k)) :
                X64.crypto_aead_chacha20poly1305_encrypt_detached(c, mac, maclen_p, m, mlen, ad, adlen, nsec, npub, k);
        }
        ...
        {
            return _is32bits
                ? (_isArm ? Arm.crypto_aead_chacha20poly1305_decrypt_detached(m, nsec, c, clen, mac, ad, adlen, npub, k) : X86.crypto_aead_chacha20poly1305_decrypt_detached(m, nsec, c, clen, mac, ad, adlen, npub, k))
                : X64.crypto_aead_chacha20poly1305_decrypt_detached(m, nsec, c, clen, mac, ad, adlen, npub, k);
        ...
        {
            return _is32bits
                ? (_isArm ? Arm.crypto_aead_chacha20poly1305_encrypt(c, clen, m, mlen, ad, adlen, nsec, npub, k) : X86.crypto_aead_chacha20poly1305_encrypt(c, clen, m, mlen, ad, adlen, nsec, npub, k))
                : X64.crypto_aead_chacha20poly1305_encrypt(c, clen, m, mlen, ad, adlen, nsec, npub, k);
        }
        ...
        {
            return _is32bits
                ? (_isArm ? Arm.crypto_aead_chacha20poly1305_decrypt(m, mlen, nsec, c, clen, ad, adlen, npub, k) : X86.crypto_aead_chacha20poly1305_decrypt(m, mlen, nsec, c, clen, ad, adlen, npub, k))
                : X64.crypto_aead_chacha20poly1305_decrypt(m, mlen, nsec, c, clen, ad, adlen, npub, k);
        }
            ...
            byte* sk)
        {
            return _is32bits
                ...
                : X64.crypto_box_seal_open(m, c, clen, pk, sk);
        }
            ...
            UIntPtr keylen)
        {
            return _is32bits
                ...
                : X64.crypto_generichash(@out, outlen, @in, inlen, key, keylen);
        }
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_box_keypair(pk, sk) : X86.crypto_box_keypair(pk, sk)) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.sodium_memcmp(b1, b2, len) : X86.sodium_memcmp(b1, b2, len)) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_box_secretkeybytes() : X86.crypto_box_secretkeybytes()) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_box_publickeybytes() : X86.crypto_box_publickeybytes()) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_kx_publickeybytes() : X86.crypto_kx_publickeybytes()) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_kx_secretkeybytes() : X86.crypto_kx_secretkeybytes()) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_box_macbytes() : X86.crypto_box_macbytes()) :
        ...
        {
            return _is32bits ?
                (_isArm ? Arm.crypto_box_noncebytes() : X86.crypto_box_noncebytes()) :
        ...
        {
            return _is32bits
                ? (_isArm ? Arm.crypto_kx_client_session_keys(rx, tx, client_pk, client_sk, server_pk) : X86.crypto_kx_client_session_keys(rx, tx, client_pk, client_sk, server_pk))
                : X64.crypto_kx_client_session_keys(rx, tx, client_pk, client_sk, server_pk);
        }
        ...
        {
            return _is32bits
                ? (_isArm ? Arm.crypto_kx_server_session_keys(rx, tx, server_pk, server_sk, client_pk) : X86.crypto_kx_server_session_keys(rx, tx, server_pk, server_sk, client_pk))
                : X64.crypto_kx_server_session_keys(rx, tx, server_pk, server_sk, client_pk);
        }
