...
task Test -depends Compile {
	...
	# "$base_dir\Raven.Tests\bin\$global:configuration\Raven.Tests.dll", "$base_dir\Raven.Tests.Bundles\bin\$global:configuration\Raven.Tests.Bundles.dll", "$base_dir\Raven.Tests.Issues\bin\$global:configuration\Raven.Tests.Issues.dll",  "$base_dir\Raven.Tests.MailingList\bin\$global:configuration\Raven.Tests.MailingList.dll",

	$test_prjs = @( "$base_dir\Raven.SlowTests\bin\$global:configuration\Raven.SlowTests.dll")
