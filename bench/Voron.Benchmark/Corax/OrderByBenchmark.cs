...
namespace Voron.Benchmark.Corax
{
    ...
    public class OrderByBenchmark
    {
        ...
        {            
            ...
            var query = _indexSearcher.OrderBy(andQuery, new OrderMetadata(ageField, true, MatchCompareFieldType.Sequence, fieldHasNoTerms: false), nullIsSmallest: true, take: TakeSize);           
