...
namespace Raven.Management.Client.Silverlight.Common
{
    ...
    {
        private static readonly IList plurals = new List<object>();
        private static readonly IList singulars = new List<object>();
        private static readonly IList uncountables = new List<object>();
