...
Run Ubuntu-based image: [run-linux.ps1](https://github.com/ravendb/ravendb/blob/v7.2/docker/run-linux.ps1)

Run Windows-based image: [run-nanoserver.ps1](https://github.com/ravendb/ravendb/blob/v7.2/docker/run-nanoserver.ps1)
...
- [Ubuntu image](https://github.com/ravendb/ravendb/tree/v7.2/docker/ravendb-ubuntu)

- [Windows image](https://github.com/ravendb/ravendb/tree/v7.2/docker/ravendb-nanoserver)
