...
namespace Raven.Tests.Core.Configuration
{
    public class ConfigurationTests
    {
        ...
        public void DefaultInMemoryRavenConfigurationShouldBeInitializedCorrectly()
        {
            ...
            configurationComparer.Assert(expected => expected.CheckReferenceBecauseOfDocumentUpdateTimeout.Value, actual => actual.CheckReferenceBecauseOfDocumentUpdateTimeout);
