    ...
    public class ConfigurationTests
    {
        ...
        public void DefaultInMemoryRavenConfigurationShouldBeInitializedCorrectly()
        {
           ...
           // configurationComparer.Ignore(x => x.TransactionMode);
            ...
            //Assert.Empty(inMemoryConfiguration.Server.AccessControlAllowOrigin);
            ...
            //Assert.True(inMemoryConfiguration.Core.Port >= 8080);
        ...
        private class ConfigurationComparer
        {
            ...
            public ConfigurationComparer(InMemoryRavenConfiguration inMemoryConfiguration, HashSet<string> propertyPathsToIgnore)
            {
