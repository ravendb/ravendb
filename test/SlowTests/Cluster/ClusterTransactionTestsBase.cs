...
{
    protected ClusterTransactionTestsBase(ITestOutputHelper output) : base(output)
    {
    }
    ...
    public virtual async Task ClusterTransactionWaitForIndexes(int docs)
    {
        var (_, leader) = await CreateRaftCluster(3);
        using (var leaderStore = InternalGetDocumentStore(new Options
        {
    ...
    public virtual async Task CanImportExportAndBackupWithClusterTransactions()
    {
    ...
    public virtual async Task TestSessionSequence()
    {
        var user1 = new User()
        {
            Name = "Karmel"
    ...
    public virtual async Task ResolveInFavorOfClusterTransaction()
    {
        var user1 = new User()
        {
            Name = "Karmel"
        ...
        using (var store1 = InternalGetDocumentStore())
    ...
    public virtual async Task TestCleanUpClusterState()
    {
        DoNotReuseServer();
        var user1 = new User()
        {
    ...
    public virtual async Task TestConcurrentClusterSessions()
    {
        var user1 = new User()
        {
            Name = "Karmel"
    ...
    public virtual async Task TestSessionMixture()
    {
        var user1 = new User()
        {
            Name = "Karmel"
    ...
    public virtual async Task CreateUniqueUser()
    {
        var (_, leader) = await CreateRaftCluster(3);
    ...
    public virtual async Task SessionCompareExchangeCommands()
    {
        using (var store = InternalGetDocumentStore())
        using (var session = store.OpenAsyncSession(new SessionOptions
        {
    ...
    public virtual async Task ClusterTxWithCounters()
    {
    ...
    public virtual void ThrowOnClusterTransactionWithCounters()
    {
        using (var store = InternalGetDocumentStore())
        {
    ...
    public virtual void ThrowOnClusterTransactionWithAttachments()
    {
        using (var store = InternalGetDocumentStore())
        {
            using (var session = store.OpenSession())
    ...
    public virtual void ThrowOnClusterTransactionWithTimeSeries()
    {
        using (var store = InternalGetDocumentStore())
        {
            using (var session = store.OpenSession())
    ...
    public virtual async Task ModifyDocumentWithRevision()
    {
        using (var store = InternalGetDocumentStore())
        {
    ...
    public virtual async Task PutDocumentInDifferentCollectionWithRevision()
    {
        using (var store = InternalGetDocumentStore())
        {
            using (var session = store.OpenAsyncSession(new SessionOptions
    ...
    public virtual async Task PutDocumentInDifferentCollection()
    {
        using (var store = InternalGetDocumentStore())
        {
            var configuration = new RevisionsConfiguration { Default = new RevisionsCollectionConfiguration { Disabled = false } };
    ...
    /// </summary>
    /// <returns></returns>
    public virtual async Task ClusterTransactionRequestWithRevisions()
    {
    ...
    public virtual async Task ThrowOnUnsupportedOperations()
    {
        using (var store = InternalGetDocumentStore())
        using (var session = store.OpenAsyncSession(new SessionOptions
        {
    ...
    public virtual async Task ThrowOnOptimisticConcurrency()
    {
        using (var store = InternalGetDocumentStore())
        {
            using (var session = store.OpenAsyncSession(new SessionOptions
    ...
    public virtual async Task ThrowOnOptimisticConcurrencyForSingleDocument()
    {
        using (var store = InternalGetDocumentStore())
        {
            using (var session = store.OpenAsyncSession(new SessionOptions
    ...
    public virtual async Task ThrowOnInvalidTransactionMode()
    {
        var user1 = new User()
        {
            Name = "Karmel"
    ...
    public virtual async Task CanAddNullValueToCompareExchange()
    {
        using (var store = InternalGetDocumentStore())
        {
            using (var session = store.OpenAsyncSession(new SessionOptions
    ...
    public virtual async Task CanGetListCompareExchange()
    {
        using (var store = InternalGetDocumentStore())
        {
            using (var session = store.OpenAsyncSession(new SessionOptions
    ...
    public virtual async Task ClusterTransactionConflict()
    {
        using (var store1 = InternalGetDocumentStore())
        using (var store2 = InternalGetDocumentStore())
        {
    ...
    public virtual async Task ClusterWideTransaction_WhenStoreDocWithEmptyStringId_ShouldThrowInformativeError(string id)
    {
    ...
    public virtual async Task ClusterTransactionShouldBeRedirectedFromPromotableNode()
    {
