...
namespace SlowTests.Bugs.MultiMap
{
    ...
    {
        public MultiMapReduce(ITestOutputHelper output) : base(output)
        {
        }
        ...
        private class UserPostingStats
        {
        ...
        private class PostCountsByUser_WithName : AbstractMultiMapIndexCreationTask<UserPostingStats>
        {
