...
namespace SlowTests.Client
{
    public class ForceRevisionCreation : RavenTestBase
    {
        ...
        [Fact]
        public async Task ForceRevisionCreationAcrossMultipleSessions()
        {
            using (var store = GetDocumentStore())
            {
                var companyId = "";
        ...
        [Fact]
        public async Task HasRevisionsFlagIsCreatedWhenForcingRevisionForDocumentThatHasNoRevisionsYet()
        {
            using (var store = GetDocumentStore())
            {
                var company1Id = "";
