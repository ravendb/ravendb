    ...
    public class ShardedSmugglerTests : RavenTestBase
    {
        ...
        public async Task CanExportAndImportDatabaseRecordToShardDatabase()
        {
            ...
            using (var pullReplicationCertificate =
                   CertificateHelper.CreateCertificateFromPfx(dummy.ServerCertificatePath, (string)null, X509KeyStorageFlags.UserKeySet | X509KeyStorageFlags.Exportable))
            {
        ...
        public async Task PullReplicationCertificateExportAndImport()
        {
            ...
            var dummy = Certificates.GenerateAndSaveSelfSignedCertificate(createNew: true);
            var pullReplicationCertificate = CertificateHelper.CreateCertificateFromPfx(dummy.ServerCertificatePath, (string)null, X509KeyStorageFlags.UserKeySet | X509KeyStorageFlags.Exportable);
