...
namespace SlowTests.Server.Documents.PeriodicBackup
{
    public class RavenDB_4163 : RavenTestBase
    {
        ...
        public void list_blobs()
        {
            ...
            var client = new RavenAzureClient(Azure.GetAzureSettings(containerName));
        ...
        private void PutBlob(int sizeInMB, bool testBlobKeyAsFolder, UploadType uploadType)
        {
            ...
            var client = new RavenAzureClient(Azure.GetAzureSettings(containerName), progress: progress);
            try
            {
                client.DeleteContainer();
                client.PutContainer();
