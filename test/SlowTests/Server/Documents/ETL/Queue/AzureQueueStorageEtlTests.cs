...
public class AzureQueueStorageEtlTests : AzureQueueStorageEtlTestBase
{
    ...
    public void SimpleScript()
    {
        using (var store = GetDocumentStore())
        {
            ...
            QueueClient queueClient = CreateAzureQueueStorageClient(ConnectionString, OrdersQueueName);
    ...
    public void ShouldDeleteDocumentsAfterProcessing()
    {
        using (var store = GetDocumentStore())
        {
            ...
            QueueClient queueClient = CreateAzureQueueStorageClient(ConnectionString, "users");
