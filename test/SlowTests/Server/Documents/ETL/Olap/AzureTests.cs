...
";
                    ...
                    using (var client = new RavenAzureClient(settings, DefaultBackupConfiguration))
                    {
...
";
        ...
        private static async Task DeleteObjects(AzureSettings azureSettings, string prefix, string delimiter, bool listFolder = false)
        {
            ...
            try
            {
                using (var client = new RavenAzureClient(azureSettings, DefaultBackupConfiguration))
                {
