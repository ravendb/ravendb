...
public abstract class RetiredAttachmentsS3Base : RetiredAttachmentsHolder<S3Settings>
{
    protected RetiredAttachmentsS3Base RetiredAttachments;
    protected RetiredAttachmentsS3Base(ITestOutputHelper output) : base(output)
    {
