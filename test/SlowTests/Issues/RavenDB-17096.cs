    ...
    public class RavenDB_17096 : ReplicationTestBase
    {
        ...
        public async Task EtlFromReAddedNodeShouldWork()
        {
            ...
            }))
            {
                ...
                await Cluster.WaitForRaftIndexToBeAppliedInCluster(deletion.RaftCommandIndex + 1, TimeSpan.FromSeconds(30));
                ...
                await Cluster.WaitForRaftIndexToBeAppliedInCluster(addResult.RaftCommandIndex, TimeSpan.FromSeconds(15));
