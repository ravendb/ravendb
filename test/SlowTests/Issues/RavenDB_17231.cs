...
namespace SlowTests.Issues
{
    public class RavenDB_17231 : ClusterTestBase
    {
        ...
        public async Task FailuresDuringEmptyQueueShouldCauseReelection()
        {
            ...
            var newLeaderElected = await Task.WhenAny(followers.Select(s => s.ServerStore.WaitForState(RachisState.Leader, cts.Token)));
            ...
            Assert.True(await leaderSteppedDown, 
            ...
            Assert.True(newLeaderElected.IsCompleted,$"newLeaderElected was not completed");
            Assert.True(newLeaderElected.Result, 
