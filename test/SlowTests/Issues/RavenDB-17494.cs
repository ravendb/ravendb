...
internal class RavenDB_17494 : ClusterTestBase
{
    ...
    public async Task DeleteSpecificRevisionsTest()
    {
        ...
        await database.DocumentsStorage.RevisionsStorage.DeleteRevisionsByChangeVectorAsync(new List<string>(){ user1deleteCv, company1deleteCv, user2deleteCv });

        await database.DocumentsStorage.RevisionsStorage.DeleteAllDocRevisionsAsync(company3.Id);
