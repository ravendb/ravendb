...
public class RavenDB_19109 : RavenTestBase
{
    ...
    private IDocumentStore GetDocumentStore(out string databasePath)
    {
    ...
    private void DoCommand(IDocumentStore store, bool disable, out Exception exception, bool shouldThrow = true)
    {
