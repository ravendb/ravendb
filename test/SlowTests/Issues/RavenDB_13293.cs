    ...
    public class RavenDB_13293 : ReplicationTestBase
    {
        ...
        public async Task CanPassNodeTagToRestoreBackupOperation()
        {
            ...
            }.Initialize())
            {
                ...
                foreach (var node in myNodesList)
                {
                    ...
                    await Cluster.WaitForRaftIndexToBeAppliedOnClusterNodes(result.RaftCommandIndex, cluster.Nodes);
        ...
        public async Task CanPassNodeTagToRestorePatchOperation()
        {
            ...
            }.Initialize())
            {
                ...
                await Cluster.WaitForRaftIndexToBeAppliedOnClusterNodes(indexResult.RaftCommandIndex, cluster.Nodes);
