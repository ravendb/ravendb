...
internal static class QuillRoutes
{
    ...
    public static string WhatsAppHealth(string slug) => $"/api/apps/{slug}/whatsapp/health";
    public static string WhatsAppPairing(string slug, string channelId) => $"/api/apps/{slug}/channels/{channelId}/whatsapp/pairing";
    public static string WhatsAppPairingRestart(string slug, string channelId) => $"{WhatsAppPairing(slug, channelId)}/restart";
