...
namespace SlowTests.Issues
{
    public class RavenDB_15807 : ReplicationTestBase
    {
        ...
        public async Task ChangeCertificateTypeInPullReplication(bool with2Eku)
        {
            ...
            var ownCertificate = CertificateHelper.CreateCertificateFromPfx(sinkCertificates.ClientCertificate1Path, (string)null, X509KeyStorageFlags.UserKeySet | CertificateLoaderUtil.FlagsForExport);
