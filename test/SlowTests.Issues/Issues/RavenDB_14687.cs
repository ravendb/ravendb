    ...
    public class RavenDB_14687 : RavenTestBase
    {
        ...
        public async Task IndexSpecificSettingShouldBeRespected(RavenTestParameters parameters)
        {
                   ...
                   }))
            {
                ...
                Assert.Equal(initialMaxStepsForScript, compiled1._engine.Constraints.Find<MaxStatementsConstraint>()!.MaxStatements);
                ...
                Assert.Equal(maxStepsForScript, compiled2._engine.Constraints.Find<MaxStatementsConstraint>()!.MaxStatements);
