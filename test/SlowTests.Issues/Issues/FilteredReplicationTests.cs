...
#pragma warning restore SYSLIB0057
        ...
        public async Task Sinks_should_not_update_hubs_change_vector3()
        {
            ...
            var fooCert = CertificateHelper.CreateCertificateFromPfx(await File.ReadAllBytesAsync(certificates.ClientCertificate2Path), (string)null,
                X509KeyStorageFlags.Exportable);

            var barCert = CertificateHelper.CreateCertificateFromPfx(await File.ReadAllBytesAsync(certificates.ClientCertificate3Path), (string)null,
                X509KeyStorageFlags.Exportable);
...
#pragma warning restore SYSLIB0057
        ...
        public async Task Can_pull_and_push_with_first_transaction_on_sink()
        {
            ...
            var pullCert = CertificateHelper.CreateCertificateFromPfx(await File.ReadAllBytesAsync(hubCertificates.ClientCertificate2Path), (string)null,
                X509KeyStorageFlags.Exportable);
