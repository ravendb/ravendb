...
namespace SlowTests.Issues
{
    ...
    {
        public RavenDB_12442(ITestOutputHelper output) : base(output)
        {
        }

        [RavenTheory(RavenTestCategory.Indexes | RavenTestCategory.Querying)]
        [RavenData(SearchEngineMode = RavenSearchEngineMode.All, Data = new object[] {Raven.Client.Constants.Documents.Indexing.Fields.NullValue})]
        [RavenData(SearchEngineMode = RavenSearchEngineMode.All, Data = new object[] {Raven.Client.Constants.Documents.Indexing.Fields.EmptyString})]
        ...
        [RavenData(SearchEngineMode = RavenSearchEngineMode.All, Data = new object[] {Raven.Client.Constants.Documents.Indexing.Fields.NullValue})]
        [RavenData(SearchEngineMode = RavenSearchEngineMode.All, Data = new object[] {Raven.Client.Constants.Documents.Indexing.Fields.EmptyString})]
        public void Can_convert_store_and_get_null_value_and_empty_string(Options options, string str)
        {
