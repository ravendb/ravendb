...
namespace SlowTests.Issues
{
    public class RavenDB_22874 : ReplicationTestBase
    {
        ...
        public async Task ArtificialTombstonesShouldNotBeReplicated(Options options)
        {
