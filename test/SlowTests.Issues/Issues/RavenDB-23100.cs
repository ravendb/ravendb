...
namespace SlowTests.Issues
{
    public class RavenDB_23100 : RavenTestBase
    {
        ...
        [RavenData(DatabaseMode = RavenDatabaseMode.Single, SearchEngineMode = RavenSearchEngineMode.All, Data = [typeof(DocumentsIndex)])]
        [RavenData(DatabaseMode = RavenDatabaseMode.Single, SearchEngineMode = RavenSearchEngineMode.All, Data = [typeof(DocumentsIndexMapReduce)])]
        public async Task Can_Delete_Document_References(Options options, Type type)
        {
        ...
        public async Task Can_Delete_Document_References_For_Legacy_Index(Options options)
        {
        ...
        [RavenTheory(RavenTestCategory.Indexes)]
        [RavenData(DatabaseMode = RavenDatabaseMode.Single, SearchEngineMode = RavenSearchEngineMode.All)]
        public async Task Can_Delete_Document_References_Map_Reduce_For_Legacy_Index(Options options)
        {
            var backupPath = NewDataPath(forceCreateDir: true);
        ...
        [RavenTheory(RavenTestCategory.Indexes)]
        [RavenData(DatabaseMode = RavenDatabaseMode.Single, SearchEngineMode = RavenSearchEngineMode.All, Data = [typeof(CompareExchangeIndex)])]
        [RavenData(DatabaseMode = RavenDatabaseMode.Single, SearchEngineMode = RavenSearchEngineMode.All, Data = [typeof(CompareExchangeMapReduceIndex)])]
        public async Task Can_Delete_CompareExchange_References(Options options, Type type)
        {
            using (var store = GetDocumentStore(options))
            {
                var index = (AbstractIndexCreationTask)Activator.CreateInstance(type);
        ...
        [RavenData(DatabaseMode = RavenDatabaseMode.Single, SearchEngineMode = RavenSearchEngineMode.All)]
        [RavenData(DatabaseMode = RavenDatabaseMode.Single, SearchEngineMode = RavenSearchEngineMode.All)]
        public async Task Can_Delete_Counters_References(Options options)
        {
            using (var store = GetDocumentStore(options))
            {
        ...
        [RavenData(DatabaseMode = RavenDatabaseMode.Single, SearchEngineMode = RavenSearchEngineMode.All)]
        [RavenData(DatabaseMode = RavenDatabaseMode.Single, SearchEngineMode = RavenSearchEngineMode.All)]
        public async Task Can_Delete_TimeSeries_References(Options options)
        {
            using (var store = GetDocumentStore(options))
            {
