...
public class FilteredPullDualClusterFirstAndSecondHopTests : FilteredPullDualClusterTestBase
{
    ...
    public async Task Document_ShouldNotInflateDatabaseChangeVectorAndShouldReplicateThroughInternalReplication(Options options, ClusterSide filteredPassReceiveSide)
    {
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "filtered document pass", nodeADbCvBeforePass, nodeADbCvAfterPass, nodeADocument.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.C, "filtered document internal hop", nodeCDbCvBeforePass, nodeCDbCvAfterPass, nodeCDocument.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
    ...
    public async Task AsymmetricFilteredHubToSinkAndUnfilteredSinkToHub_ShouldUseReceiverLocalOrderAndKeepHubDbCvClean(Options options)
    {
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "asymmetric filtered/unfiltered document pass", hubADbCvBeforePass, hubADbCvAfterPass, hubADocument.ChangeVector, originalIncomingChangeVector, hubBDatabaseId);
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.C, "asymmetric filtered/unfiltered document internal hop", hubCDbCvBeforePass, hubCDbCvAfterPass, hubCDocument.ChangeVector, originalIncomingChangeVector, hubBDatabaseId);
    ...
    public async Task ConflictDocument_ShouldNotInflateDatabaseChangeVectorAndShouldReplicateThroughInternalReplication(Options options, ClusterSide filteredPassReceiveSide)
    {
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "filtered conflict pass", nodeADbCvBeforePass, nodeADbCvAfterPass, nodeAConflict.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.C, "filtered conflict internal hop", nodeCDbCvBeforePass, nodeCDbCvAfterPass, nodeCConflict.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
    ...
    public async Task DocumentTombstone_ShouldNotInflateDatabaseChangeVectorAndShouldReplicateThroughInternalReplication(Options options, ClusterSide filteredPassReceiveSide)
    {
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "filtered document tombstone pass", nodeADbCvBeforePass, nodeADbCvAfterPass, nodeATombstone.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.C, "filtered document tombstone internal hop", nodeCDbCvBeforePass, nodeCDbCvAfterPass, nodeCTombstone.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
    ...
    public async Task RevisionDocument_ShouldNotInflateDatabaseChangeVectorAndShouldReplicateThroughInternalReplication(Options options, ClusterSide filteredPassReceiveSide)
    {
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "filtered revision document pass", nodeADbCvBeforePass, nodeADbCvAfterPass, nodeARevision.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.C, "filtered revision document internal hop", nodeCDbCvBeforePass, nodeCDbCvAfterPass, nodeCRevision.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
    ...
    public async Task RevisionTombstone_ShouldNotInflateDatabaseChangeVectorAndShouldReplicateThroughInternalReplication(Options options, ClusterSide filteredPassReceiveSide)
    {
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "filtered revision tombstone pass", nodeADbCvBeforePass, nodeADbCvAfterPass, nodeATombstone.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.C, "filtered revision tombstone internal hop", nodeCDbCvBeforePass, nodeCDbCvAfterPass, nodeCTombstone.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
    ...
    public async Task Counter_ShouldNotInflateDatabaseChangeVectorAndShouldReplicateThroughInternalReplication(Options options, ClusterSide filteredPassReceiveSide)
    {
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "filtered counter pass", nodeADbCvBeforePass, nodeADbCvAfterPass, nodeACounter.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.C, "filtered counter internal hop", nodeCDbCvBeforePass, nodeCDbCvAfterPass, nodeCCounter.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
    ...
    public async Task CounterDeletion_ShouldNotInflateDatabaseChangeVectorAcrossFilteredFirstAndSecondHops(Options options, ClusterSide filteredPassReceiveSide)
    {
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "filtered counter deletion pass", nodeADbCvBeforePass, nodeADbCvAfterPass, nodeARetainedCounter.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.C, "filtered counter deletion internal hop", nodeCDbCvBeforePass, nodeCDbCvAfterPass, nodeCRetainedCounter.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
    ...
    public async Task Attachment_ShouldNotInflateDatabaseChangeVectorAndShouldReplicateThroughInternalReplication(Options options, ClusterSide filteredPassReceiveSide)
    {
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "filtered attachment pass", nodeADbCvBeforePass, nodeADbCvAfterPass, nodeAAttachment.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.C, "filtered attachment internal hop", nodeCDbCvBeforePass, nodeCDbCvAfterPass, nodeCAttachment.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
    ...
    public async Task AttachmentTombstone_ShouldNotInflateDatabaseChangeVectorAndShouldReplicateThroughInternalReplication(Options options, ClusterSide filteredPassReceiveSide)
    {
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "filtered attachment tombstone pass", nodeADbCvBeforePass, nodeADbCvAfterPass, nodeATombstone.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.C, "filtered attachment tombstone internal hop", nodeCDbCvBeforePass, nodeCDbCvAfterPass, nodeCTombstone.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
    ...
    public async Task AttachmentRestoredFromRevisionAfterFilteredTombstone_ShouldPreserveAttachmentTombstoneLineage(Options options)
    {
        ...
        // Verify the filtered pass into node A keeps attachment tombstone lineage in Version only.
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "filtered attachment tombstone before revision revert", nodeADbCvBeforePass, nodeADbCvAfterPass, nodeATombstone.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
    ...
    public async Task TimeSeriesSegment_NewSegment_ShouldNotInflateDatabaseChangeVectorAndShouldReplicateThroughInternalReplication(Options options, ClusterSide filteredPassReceiveSide)
    {
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "filtered time series segment pass", nodeADbCvBeforePass, nodeADbCvAfterPass, nodeASegment.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.C, "filtered time series segment internal hop", nodeCDbCvBeforePass, nodeCDbCvAfterPass, nodeCSegment.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
    ...
    public async Task TimeSeriesSegment_UpdateExistingSegment_ShouldNotInflateDatabaseChangeVectorAndShouldReplicateThroughInternalReplication(Options options, ClusterSide filteredPassReceiveSide)
    {
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "filtered updated time series segment pass", nodeADbCvBeforePass, nodeADbCvAfterPass, nodeASegment.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.C, "filtered updated time series segment internal hop", nodeCDbCvBeforePass, nodeCDbCvAfterPass, nodeCSegment.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
    ...
    public async Task TimeSeriesDeletedRange_ShouldNotInflateDatabaseChangeVectorAndShouldReplicateThroughInternalReplication(Options options, ClusterSide filteredPassReceiveSide)
    {
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.A, "filtered deleted time series range pass", nodeADbCvBeforePass, nodeADbCvAfterPass, nodeADeletedRange.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
        ...
        AssertDatabaseChangeVectorDidNotReachFilteredOutUser(lab, filteredPassReceiveSide, LabNode.C, "filtered deleted time series range internal hop", nodeCDbCvBeforePass, nodeCDbCvAfterPass, nodeCDeletedRange.ChangeVector, originalIncomingChangeVector, nodeBDatabaseId);
    ...
    private static void AssertDatabaseChangeVectorDidNotReachFilteredOutUser(
        DualClusterLab lab,
        ClusterSide filteredPassReceiveSide,
        LabNode node,
        string itemDescription,
        ...
        string nodeBDatabaseId)
    {
        ...
        var allowedTicketChangeVector = lab.GetAllowedTicketBeforeFilteredOutUser(LabNode.B).ChangeVector;
        var filteredOutUserChangeVector = lab.GetFilteredOutUser(LabNode.B).ChangeVector;
        var allowedTicketEtag = GetEtag(allowedTicketChangeVector, nodeBDatabaseId);
        var filteredOutUserEtag = GetEtag(filteredOutUserChangeVector, nodeBDatabaseId);
        var passedItemEtag = GetVersionEtag(originalIncomingChangeVector, nodeBDatabaseId);

        Assert.True(
            beforePassEtag < allowedTicketEtag && allowedTicketEtag < filteredOutUserEtag && filteredOutUserEtag < passedItemEtag,
            $"Expected test setup order before DB CV assertion to be: before-pass < allowed ticket < filtered-out user < passed item. " +
            $"beforePassEtag={beforePassEtag}, allowedTicketEtag={allowedTicketEtag}, filteredOutUserEtag={filteredOutUserEtag}, passedItemEtag={passedItemEtag}. " +
            $"dbCVBefore='{databaseChangeVectorBeforePass ?? "<null>"}', allowedTicketCV='{allowedTicketChangeVector ?? "<null>"}', " +
            $"filteredOutUserCV='{filteredOutUserChangeVector ?? "<null>"}', originalIncomingCV='{originalIncomingChangeVector ?? "<null>"}'.");

        Assert.True(
            afterPassEtag < filteredOutUserEtag,
            $"Expected {NodeTag(filteredPassReceiveSide, node)} DB CV after {itemDescription} not to reach the filtered-out user on {NodeTag(filteredPassReceiveSide, LabNode.B)}. " +
            $"Expected after-pass etag < filtered-out user etag, before-pass etag={beforePassEtag}, allowed ticket etag={allowedTicketEtag}, " +
            $"filtered-out user etag={filteredOutUserEtag}, after-pass etag={afterPassEtag}. " +
            ...
            $"allowedTicketCV='{allowedTicketChangeVector ?? "<null>"}', filteredOutUserCV='{filteredOutUserChangeVector ?? "<null>"}', " +
            $"itemCV='{itemChangeVector ?? "<null>"}', originalIncomingCV='{originalIncomingChangeVector ?? "<null>"}'.");
    }
