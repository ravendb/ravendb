    ...
    public class RavenDB_26662 : QuillAppServerTestBase
    {
        ...
        public async Task WithoutQuillConfig_NothingIsSnapshottedOrReported()
        {
            ...
            using (GetDocumentStore())
            {
                ...
                using (var reporter = new WriteUsageReporter(Server.ServerStore, Server.ServerStore.Observer, Server.ServerStore.Engine.CurrentCommittedState.Term, Server.ServerStore.ServerShutdown))
                {
