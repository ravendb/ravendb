...
#if DEBUG
            var serverDirectory = @"../../../../../src/Raven.Server/bin/x64/Debug/net9.0";
            if (Directory.Exists(serverDirectory) == false) // this can happen when running directly from CLI e.g. dotnet xunit
                serverDirectory = @"../../../../../src/Raven.Server/bin/Debug/net9.0";
#else
            var serverDirectory = @"../../../../../src/Raven.Server/bin/x64/Release/net9.0";
            if (Directory.Exists(serverDirectory) == false) // this can happen when running directly from CLI e.g. dotnet xunit
                serverDirectory = @"../../../../../src/Raven.Server/bin/Release/net9.0";
#endif
