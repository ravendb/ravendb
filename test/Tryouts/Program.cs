...
namespace Tryouts
{
    ...
    {
        public void ImportTask(bool inMem)
        {
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            using (var massiveObj = new MassiveTest("http://localhost:8080", 1805861237))
            {
                ...
                Console.WriteLine("forOverrite...");
                massiveObj.PerformBulkInsert("forOverrite", 1000 * k, 2 * kb, false);
                // Console.WriteLine("forOverrite2...");
                // massiveObj.PerformBulkInsert("forOverrite", 10000 * k, 2 * kb, false);
