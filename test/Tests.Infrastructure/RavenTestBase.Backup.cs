...
namespace FastTests
{
    public abstract partial class RavenTestBase
    {
        ...
        public class BackupTestBase
        {
            ...
            public async Task<RavenCommand<OperationState>> ExecuteGetOperationStateCommand(DocumentStore store, long operationId, string responsibleNode = null)
            {
            ...
            public async Task CheckBackupOperationStatus(OperationStatus expected, RavenCommand<OperationState> command, DocumentStore store, long taskId, long opId,
