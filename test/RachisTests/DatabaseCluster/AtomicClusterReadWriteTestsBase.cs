...
{
    protected AtomicClusterReadWriteTestsBase(ITestOutputHelper output) : base(output)
    {
    }
    ...
    public virtual async Task ClusterWideTransaction_WhenLoadAndDeleteWhileUpdated_ShouldFailDeletion()
    {
    ...
    public virtual async Task ClusterWideTransaction_WhenRestoreFromIncrementalBackupAfterStoreAndUpdateWithoutLoad_ShouldFail()
    {
