...
public class RavenDB_25918 : RavenTestBase
{
    ...
    public void AssertNotificationReasonsIntegrity()
    {
        ...
        Assert.Equal(77, Enum.GetNames(typeof(AlertReason)).Length);
        Assert.Equal(AlertReason.CdcSink_ConsumerCreationError, Enum.GetValues(typeof(AlertReason)).Cast<AlertReason>().Last());
