...
public class RavenDB_25918 : RavenTestBase
{
    ...
    public void AssertNotificationReasonsIntegrity()
    {
        ...
        Assert.Equal(73, Enum.GetNames(typeof(AlertReason)).Length);
        Assert.Equal(AlertReason.Etl_HealthStatusChange, Enum.GetValues(typeof(AlertReason)).Cast<AlertReason>().Last());
