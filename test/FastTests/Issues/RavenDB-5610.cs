    ...
    public class RavenDB_5610 : RavenLowLevelTestBase
    {
        ...
        public async Task UpdateType()
        {
            using (var database = CreateDocumentDatabase())
            {
                ...
                var options = IndexStore.GetIndexCreationOptions(indexDefinition, index.ToIndexInformationHolder(), database.Configuration, out var _);
                ...
                options = IndexStore.GetIndexCreationOptions(indexDefinition, index.ToIndexInformationHolder(), database.Configuration, out var _);
