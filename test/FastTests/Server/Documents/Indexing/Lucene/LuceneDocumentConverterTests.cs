...
namespace FastTests.Server.Documents.Indexing.Lucene
{
    public class LuceneDocumentConverterTests : RavenLowLevelTestBase
    {
        ...
        public void Returns_null_value_if_property_is_null()
        {
            ...
            bool shouldSkip;
            _sut.SetDocument(doc.Id, null, doc, _ctx, out shouldSkip);
        ...
        public void Reuses_cached_document_instance()
        {
            ...
            bool shouldSkip;
            _sut.SetDocument(doc1.Id, null, doc1, _ctx, out shouldSkip);
            ...
            _sut.SetDocument(doc2.Id, null, doc2, _ctx, out shouldSkip);
        ...
        public void Conversion_of_complex_value()
        {
            ...
            bool shouldSkip;
            using (_sut.SetDocument(doc.Id, null, doc, _ctx, out shouldSkip))
            {
