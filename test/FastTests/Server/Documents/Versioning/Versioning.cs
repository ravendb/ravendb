...
namespace FastTests.Server.Documents.Versioning
{
    public class Versioning : VersioningTest
    {
        ...
        [Fact]
        public async Task Can_exclude_entities_from_versioning()
        {
     ...
     /*   [Fact]
        public async Task Will_automatically_update_metadata_on_next_insert()
        {
            var company = new Company { Name = "Company Name" };
            using (var store = await GetDocumentStore())
            {
        ...
        [Fact]
        public async Task Will_automatically_create_duplicate_on_first_insert()
        {
            var company = new Company { Name = "Company Name" };
            using (var store = await GetDocumentStore())
            {
        ...
        [Fact]
        public async Task Will_automatically_create_duplicate_on_next_insert()
        {
            var company = new Company { Name = "Company Name" };
            using (var store = await GetDocumentStore())
            {
        ...
        [Fact]
        public async Task Can_get_all_revisions()
        {
            var company = new Company { Name = "Company Name" };
            using (var store = await GetDocumentStore())
            {
        ...
        [Fact]
        public async Task Will_create_revision_if_explicitly_requested()
        {
        ...
        [Fact]
        public async Task Will_not_create_revision_if_not_explicitly_requested()
        {
            var product = new Product() { Description = "A fine document db", Quantity = 5 };
            using (var store = await GetDocumentStore())
            {
