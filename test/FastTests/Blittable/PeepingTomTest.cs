...
namespace FastTests.Blittable
{
    public class PeepingTomTest
    {
        ...
        {
            PeepingTomStreamTest(originalSize, chunkSizeToRead, offset);
        }
        ...
        public void PeepingTomStreamTest(int originalSize, int chunkSizeToRead, int offset)
        {
            ...
            {
                var peeping = new PeepingTomStream(stream);
