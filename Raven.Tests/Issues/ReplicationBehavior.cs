...
namespace Raven.Tests.Issues
{
	public class ReplicationBehavior
	{
		...
		public void BackoffStrategy()
		{
			...
			{
				var req = i + 1;
				replicationInformer.ExecuteWithReplication("GET", "http://localhost:1", new OperationMetadata.OperationCredentials(null, CredentialCache.DefaultNetworkCredentials), req, 1, url =>
				{
		...
		public void ReadStriping()
		{
			...
			{
				var req = i + 1;
				replicationInformer.ExecuteWithReplication("GET", "http://localhost:1", new OperationMetadata.OperationCredentials(null, CredentialCache.DefaultNetworkCredentials), req, req, url =>
				{
					urlsTried.Add(Tuple.Create(req, url.Url));
					return 1;
				});
