...
namespace Raven.Tests.Storage
{
	public class CreateUpdateDeleteDocuments : RavenTest
	{
		...
		{
			var documentId = db.Put("1", Etag.Empty, RavenJObject.Parse("{ first_name: 'ayende', last_name: 'rahien'}"),
		...
		{
			var documentId = db.Put(null, Etag.Empty, RavenJObject.Parse("{ first_name: 'ayende', last_name: 'rahien'}"),
									new RavenJObject(), null);
		...
		{
			db.Put("1", Etag.Empty, RavenJObject.Parse("{  first_name: 'ayende', last_name: 'rahien'}"), new RavenJObject(), null);
		...
		{
			db.Put("1", Etag.Empty, RavenJObject.Parse("{ first_name: 'ayende', last_name: 'rahien'}"), new RavenJObject(), null);
			db.Put("21", Etag.Empty, RavenJObject.Parse("{ first_name: 'ayende2', last_name: 'rahien2'}"), new RavenJObject(), null);
