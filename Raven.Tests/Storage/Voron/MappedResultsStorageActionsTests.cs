	...
	public class MappedResultsStorageActionsTests : TransactionalStorageTestBase
	{
			...
			using (var storage = NewTransactionalStorage(requestedStorage))
			{
				...
				storage.Batch(accessor =>
				{
					var keys = accessor.MapReduce
						.GetKeysForIndexForDebug(303, null, 0, 10)
						.ToList();
					...
					keys = accessor.MapReduce
						.GetKeysForIndexForDebug(404, null, 0, 10)
						.ToList();
					...
					keys = accessor.MapReduce
						.GetKeysForIndexForDebug(505, null, 0, 10)
						.ToList();
				...
				storage.Batch(accessor =>
				{
					...
					keys = accessor.MapReduce
						.GetKeysForIndexForDebug(303, null, 0, 1)
						.ToList();
					...
					keys = accessor.MapReduce
						.GetKeysForIndexForDebug(303, null, 1, 1)
						.ToList();
					...
					keys = accessor.MapReduce
						.GetKeysForIndexForDebug(303, null, 2, 1)
						.ToList();
					...
					keys = accessor.MapReduce
						.GetKeysForIndexForDebug(303, null, 3, 1)
						.ToList();

					Assert.Equal(0, keys.Count);

					keys = accessor.MapReduce
						.GetKeysForIndexForDebug(303, null, 0, 2)
						.ToList();
					...
					keys = accessor.MapReduce
						.GetKeysForIndexForDebug(303, null, 1, 2)
						.ToList();
					...
					keys = accessor.MapReduce
						.GetKeysForIndexForDebug(303, null, 2, 2)
						.ToList();
		...
		public void GetKeysForIndexForDebug2(string requestedStorage)
		{
			using (var storage = NewTransactionalStorage(requestedStorage))
			{
				...
				{
					var keys = accessor.MapReduce
						.GetKeysForIndexForDebug(303, "reduceKey", 0, 10)
						.ToList();
					...
					keys = accessor.MapReduce
						.GetKeysForIndexForDebug(303, "reduceKey/1", 0, 10)
						.ToList();
