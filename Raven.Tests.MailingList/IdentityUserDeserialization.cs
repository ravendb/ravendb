...
namespace Raven.Tests.MailingList
{
    ...
    public class IdentityUserLogin<TKey> where TKey : IEquatable<TKey>
    {
		...
		public class IdentityUser<TKey> where TKey : IEquatable<TKey>
		{
			public IdentityUser()
			{
				Roles = new Collection<IdentityUserRole<TKey>>();
				Claims = new Collection<IdentityUserClaim<TKey>>();
				Logins = new Collection<IdentityUserLogin<TKey>>();
			}
			...
			///     Roles for the user
			/// </summary>
			public virtual ICollection<IdentityUserRole<TKey>> Roles { get; set; }
			...
			/// </summary>
			public virtual ICollection<IdentityUserLogin<TKey>> Logins { get; set; }
		}
