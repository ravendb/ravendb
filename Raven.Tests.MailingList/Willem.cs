...
namespace Raven.Tests.MailingList
{
	...
	public class Sales_ByDateProduct : AbstractIndexCreationTask<Order, Sales_ByDateProduct.ReduceResult>
	{
	...
	public class Order : LocationBaseDocument
	{
	...
	public class GuestCollection : Collection<Guest>
	{
	...
	public abstract class LocationBaseDocument : BaseDocument
	{
		public int LocationId { get; set; }
	}

	public abstract class CompanyBaseDocument : BaseDocument
	{
