...
class tasks extends viewModelBase {
    ...
    constructor() {
        ...
        if (this.activeDatabase().isAdminCurrentTenant()) {
            routeArray.push({ route: 'databases/tasks/toggleIndexing', moduleId: 'viewmodels/toggleIndexing', title: 'Toggle Indexing', nav: true, hash: toggleIndexingUrl });
        }
