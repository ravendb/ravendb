...
class tasks extends viewModelBase {
    ...
    constructor() {
        ...
        var routeArray: DurandalRouteConfiguration[] = [
            { route: ["filesystems/tasks", "filesystems/tasks/importFilesystem"], moduleId: "viewmodels/filesystem/importFilesystem", title: "Import File System", nav: true, hash: importFilesystemUrl },
            { route: "filesystems/tasks/exportFilesystem", moduleId: "viewmodels/filesystem/exportFilesystem", title: "Export File System", nav: true, hash: exportFilesystemUrl }
        ];
