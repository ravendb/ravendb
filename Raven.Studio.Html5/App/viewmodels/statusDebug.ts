	...
	constructor() {
        ...
        this.router = status.statusRouter.createChildRouter()
            .map([
                ...
                { route: 'databases/status/debug/indexFields',       moduleId: 'viewmodels/statusDebugIndexFields',       title: 'Index fields',      tooltip: "Shows names of indexed fields based on entered query", nav: true, hash: appUrl.forCurrentDatabase().statusDebugIndexFields },
