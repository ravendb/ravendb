...
class statusDebug extends viewModelBase {
	...
	constructor() {
	    ...
	    [
	        ...
	        { route: 'databases/status/debug/explainReplication', moduleId: 'viewmodels/statusDebugExplainReplication', title: 'Explain replication', tooltip: "Shows information about replication of given document to given replication destination", nav: true, hash: appUrl.forCurrentDatabase().statusDebugExplainReplication },
	    ];
