	...
	constructor() {
        ...
        this.router = durandalRouter.createChildRouter()
            .map([
                ...
                { route: 'databases/status/replicationPerfStats', moduleId: 'viewmodels/replicationPerfStats', title: 'Replication stats', nav: true, hash: appUrl.forCurrentDatabase().replicationPerfStats },
