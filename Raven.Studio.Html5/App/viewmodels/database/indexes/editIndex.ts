...
class editIndex extends viewModelBase { 
    ...
    addMaxIndexOutputsPerDocument() {
        eventsCollector.default.reportEvent("index", "add-max-index-outputs");
        this.editMaxIndexOutputsPerDocument(true);
    }

    addStoreAllFields() {
        eventsCollector.default.reportEvent("index", "add-store-all-fields");
        this.editedIndex().setOrRemoveStoreAllFields(true);
    }
