...
class aceEditorBindingHandler {
    ...
    init(element: HTMLElement,
        ...
        $(element).append('<span class="fullScreenModeLabel" style="font-size:90%; z-index:200; position:absolute; bottom:22px; right:22px;opacity:0.4">Press Shift+F11 to enter full screen mode</span>');
