...
class extendRaftClusterCommand extends commandBase {
    ...
    execute(): JQueryPromise<any> {
        if (this.create) {
            ...
            return this.post("/admin/raft/create", ko.toJSON(this.connectionInfo), this.db, { dataType: undefined })
            ...
            return this.post("/admin/raft/join", ko.toJSON(this.connectionInfo), this.db, { dataType: undefined })
