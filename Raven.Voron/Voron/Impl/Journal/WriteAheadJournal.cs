...
namespace Voron.Impl.Journal
{
    public unsafe class WriteAheadJournal : IDisposable
    {
        ...
        private void ApplyPagesToDataFileFromJournal(IFileWriter writer, List<Page> sortedPagesToWrite)
        {
            ...
            writer.EnsureContinuous(last.PageNumber, numberOfPagesInLastPage);
