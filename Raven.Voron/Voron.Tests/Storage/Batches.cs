namespace Voron.Tests.Storage
{
    ...
    public class Batches : StorageTest
    {
        ...
        public async Task BatchErrorHandling()
        {
            ...
            var batch2 = new WriteBatch();
            batch2.Add("key/1", new MemoryStream(Encoding.UTF8.GetBytes("tree2")), "tree2",version: 128);
            ...
            {
				Assert.Equal("Cannot add 'key/1' to 'tree2' tree. Version mismatch. Expected: 128. Actual: 0.", e.InnerException.Message);
