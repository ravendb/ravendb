// -----------------------------------------------------------------------
//  <copyright file="DatabaseRequestDurationLastMinuteMax.cs" company="Hibernating Rhinos LTD">
...
{
    public class DatabaseRequestDurationLastMinuteMax : DatabaseScalarObjectBase<Gauge32>
    {
        public DatabaseRequestDurationLastMinuteMax(string databaseName, DatabasesLandlord landlord, int index)
            : base(databaseName, landlord, "5.2.{0}.3.4.2.3", index)
        {
        }
