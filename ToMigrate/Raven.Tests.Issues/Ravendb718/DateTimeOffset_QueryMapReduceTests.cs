...
{
    public class DateTimeOffset_QueryMapReduceTests : RavenTest
    {
        [Fact]
        public void DateTimeOffset_FromNow_OnMapReduceIndex_Queries_WithCorrectOffset()
        {
            DoTest(DateTimeOffset.Now);
        }

        [Fact]
        public void DateTimeOffset_FromUtcNow_OnMapReduceIndex_Queries_WithCorrectOffset()
        {
            DoTest(DateTimeOffset.UtcNow);
        }

        [Fact]
        public void DateTimeOffset_FromNew_OnMapReduceIndex_Queries_WithCorrectOffset()
        {
